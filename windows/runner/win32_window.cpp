                         ...
                         const Size &size)
{
  ...
  // Set high-resolution icons for taskbar (ICON_BIG) and title bar (ICON_SMALL).
...
void Win32Window::UpdateTheme(HWND const window)
{
  ...
  // Use RtlGetVersion (ntdll) to bypass the GetVersionEx deprecation shim
  ...
  // Windows 10 = major 10, build 17763 (1809) introduced immersive dark mode
