...
WelcomeLabel2=现在将把 [name/ver] 安装到您的电脑中。%n%n建议在继续前关闭其它应用程序。
...
SelectDirBrowseLabel=点击“下一步”继续；如果要更改文件夹，请点击“浏览”。
...
FinishedLabel=安装程序已成功将 [name] 安装到您的电脑中。您可以通过创建的快捷方式启动它。
