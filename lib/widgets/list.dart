...
/// White rounded card used to wrap settings sections in light mode.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isDark
            ? null
            : Border.all(color: const Color(0xFFEEF0F4), width: 0.5),
        boxShadow: isDark
            ? null
            : const [
                BoxShadow(
...
/// Public section card for use in sub-pages.
