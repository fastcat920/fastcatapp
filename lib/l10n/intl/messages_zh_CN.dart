...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(rate) => "当前综合佣金返利比例：${rate}%";

  static m1(label) => "确定删除选中的${label}吗？";

  static m2(label) => "确定删除当前${label}吗？";

  static m3(label) => "${label}不能为空";

  static m4(label) => "${label}当前已存在";

  static m5(error) => "退出失败：${error}";

  static m6(amount) => "最大可划转: ¥${amount}";

  static m7(label) => "暂无${label}";

  static m8(label) => "${label}必须为数字";

  static m9(statusCode) => "获取消息失败: ${statusCode}";

  static m10(error) => "选择图片失败: ${error}";

  static m11(method) => "不支持的HTTP方法: ${method}";

  static m12(error) => "上传失败: ${error}";

  static m13(amount) => "订单金额: ${amount}";

  static m14(orderNo) => "订单: ${orderNo}";

  static m15(page) => "第 ${page} 页";

  static m16(label) => "${label} 必须在 1024 到 49151 之间";

  static m17(e) => "注册失败: ${e}";

  static m18(count) => "已选择 ${count} 项";

  static m19(e) => "发送验证码失败: ${e}";

  static m20(date) => "套餐已于 ${date} 过期，请续费后继续使用";

  static m21(days) => "套餐将在 ${days} 天后过期，建议及时续费";

  static m22(days) => "订阅将在 ${days} 天后过期";

  static m23(count) => "共 ${count} 条记录";

  static m24(amount) => "划转金额不能超过 ¥${amount}";

  static m25(error) => "划转失败：${error}";

  static m26(amount) => "划转成功！已划转 ¥${amount} 到钱包";

  static m27(version) => "当前版本: ${version}";

  static m28(version) => "强制更新: ${version}";

  static m29(version) => "发现新版本: ${version}";

  static m30(statusCode) => "服务器返回错误状态码 ${statusCode}";

  static m31(label) => "${label}必须为URL";

  static m32(email) => "验证码已发送到 ${email}，请查收并输入验证码和新密码";

  static m33(error) => "提交失败：${error}";

  static m34(amount) => "可提现金额: ${amount}";

  static m35(amount) => "¥${amount}";

  static m36(count, limit) => "活跃 ${count} 台 · 限额 ${limit}";

  static m37(date) => "已于 ${date} 到期";

  static m38(date) => "有效期至 ${date}";

  static m39(date, days) => "于 ${date} 到期，距离到期还有 ${days} 天";

  static m40(error) => "兑换失败: ${error}";

  static m41(days) => "已用流量将在 ${days} 天后重置";

  static m42(time) => "运行时间: ${time}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'accessControlAllowDesc': MessageLookupByLibrary.simpleMessage('只允许选中应用进入VPN'),
    'accessControlDesc': MessageLookupByLibrary.simpleMessage('配置应用访问代理'),
    'accessControlNotAllowDesc': MessageLookupByLibrary.simpleMessage('选中应用将会被排除在VPN之外'),
    ...
    'backupAndRecoveryDesc': MessageLookupByLibrary.simpleMessage('通过WebDAV或者文件同步数据'),
    ...
    'cannotOpenBrowser': MessageLookupByLibrary.simpleMessage('无法打开浏览器，请手动访问网页版'),
    ...
    'commissionSettled': MessageLookupByLibrary.simpleMessage('佣金将在好友订阅成功后结算到账户'),
    ...
    'completeWithdrawal': MessageLookupByLibrary.simpleMessage('网页版提供更完整的提现功能和支付方式选择'),
    ...
    'disclaimerDesc': MessageLookupByLibrary.simpleMessage('本软件目前在公测阶段，如果收到更新提醒，请前往更新。旧版本容易导致服务不稳定或无法使用。'),
    ...
    'enterEmailForReset': MessageLookupByLibrary.simpleMessage('请输入您的邮箱地址，我们会发送验证码到您的邮箱'),
    ...
    'externalControllerDesc': MessageLookupByLibrary.simpleMessage('开启后将可以通过9090端口控制Clash内核'),
    ...
    'friendInviteReward': MessageLookupByLibrary.simpleMessage('好友邀请的人成功消费，您也能赚取佣金'),
    ...
    'inviteCodeRequiredMessage': MessageLookupByLibrary.simpleMessage('注册需要邀请码，请联系已注册用户获取邀请码后再进行注册。'),
    'inviteLinkCopied': MessageLookupByLibrary.simpleMessage('邀请链接已复制，可分享给好友'),
    'inviteRegisterReward': MessageLookupByLibrary.simpleMessage('邀请好友注册并成功订阅，即可获得佣金奖励'),
    ...
    'logoutConfirmMsg': MessageLookupByLibrary.simpleMessage('确定要退出当前账户吗？退出后需要重新登录。'),
    'logoutFailed': m5,
    ...
    'onlineSupportApiConfigNotFound': MessageLookupByLibrary.simpleMessage('在线客服API配置未找到，请检查配置'),
    ...
    'onlineSupportClearHistoryConfirm': MessageLookupByLibrary.simpleMessage('确定要清除所有聊天历史记录吗？此操作不可恢复。'),
    'onlineSupportClickToSelect': MessageLookupByLibrary.simpleMessage('点击选择图片'),
    ...
    'onlineSupportConnectionError': MessageLookupByLibrary.simpleMessage('连接错误'),
    'onlineSupportDisconnected': MessageLookupByLibrary.simpleMessage('已断开'),
    'onlineSupportGetMessagesFailed': m9,
    'onlineSupportInputHint': MessageLookupByLibrary.simpleMessage('请输入您的问题...'),
    'onlineSupportNoMessages': MessageLookupByLibrary.simpleMessage('暂无消息，发送消息开始咨询'),
    ...
    'onlineSupportSendMessageFailed': MessageLookupByLibrary.simpleMessage('发送消息失败: 无法获取认证token'),
    'onlineSupportSupportedFormats': MessageLookupByLibrary.simpleMessage('支持 JPG, PNG, GIF, WebP, BMP\n最大 10MB'),
    'onlineSupportTitle': MessageLookupByLibrary.simpleMessage('在线客服'),
    'onlineSupportTokenNotFound': MessageLookupByLibrary.simpleMessage('未找到认证token'),
    'onlineSupportUnsupportedHttpMethod': m11,
    'onlineSupportUploadFailed': m12,
    'onlineSupportWebSocketConfigNotFound': MessageLookupByLibrary.simpleMessage('在线客服WebSocket配置未找到，请检查配置'),
    ...
    'onlyStatisticsProxyDesc': MessageLookupByLibrary.simpleMessage('开启后，将只统计代理流量'),
    ...
    'passwordResetSuccessful': MessageLookupByLibrary.simpleMessage('密码重置成功！请使用新密码登录'),
    ...
    'pleaseConfirmNewPassword': MessageLookupByLibrary.simpleMessage('请再次输入新密码'),
    'pleaseConfirmPassword': MessageLookupByLibrary.simpleMessage('请确认密码'),
    'pleaseEnterAtLeast8CharsPassword': MessageLookupByLibrary.simpleMessage('请输入至少8位密码'),
    ...
    'pleaseEnterEmailVerificationCode': MessageLookupByLibrary.simpleMessage('请输入邮箱验证码'),
    ...
    'pleaseEnterValidEmailAddress': MessageLookupByLibrary.simpleMessage('请输入有效的邮箱地址'),
    'pleaseEnterValidVerificationCode': MessageLookupByLibrary.simpleMessage('请输入有效的验证码'),
    'pleaseEnterVerificationCode': MessageLookupByLibrary.simpleMessage('请输入邮箱验证码'),
    'pleaseEnterWithdrawAccount': MessageLookupByLibrary.simpleMessage('请输入提现账号'),
    'pleaseEnterYourEmailAddress': MessageLookupByLibrary.simpleMessage('请输入您的邮箱地址'),
    ...
    'pleaseSelectWithdrawMethod': MessageLookupByLibrary.simpleMessage('请选择提现方式'),
    ...
    'registerSuccessSaveCredentials': MessageLookupByLibrary.simpleMessage('注册成功 - 保存凭据:'),
    ...
    'respectRulesDesc': MessageLookupByLibrary.simpleMessage('DNS连接跟随rules,需配置proxy-server-nameserver'),
    ...
    'saveQrCodeFeature': MessageLookupByLibrary.simpleMessage('保存二维码功能开发中，敬请期待'),
    ...
    'subscriptionExpiresTodayDetail': MessageLookupByLibrary.simpleMessage('套餐将在今日过期，请立即续费以免影响使用'),
    'subscriptionExpiringInDays': MessageLookupByLibrary.simpleMessage('订阅即将过期'),
    'subscriptionExpiringInDaysDetail': m21,
    'subscriptionNoSubscription': MessageLookupByLibrary.simpleMessage('无订阅套餐'),
    'subscriptionNoSubscriptionDetail': MessageLookupByLibrary.simpleMessage('当前账户暂无可用的订阅套餐，请购买套餐后使用'),
    'subscriptionNotLoggedIn': MessageLookupByLibrary.simpleMessage('未登录'),
    'subscriptionNotLoggedInDetail': MessageLookupByLibrary.simpleMessage('请先登录账户'),
    'subscriptionTrafficExhausted': MessageLookupByLibrary.simpleMessage('流量已用完'),
    'subscriptionTrafficExhaustedDetail': MessageLookupByLibrary.simpleMessage('套餐流量已用完，请购买更多流量或升级套餐'),
    ...
    'updateCheckAllServersUnavailable': MessageLookupByLibrary.simpleMessage('所有配置的更新服务器都不可用'),
    ...
    'updateCheckNoServerUrlsConfigured': MessageLookupByLibrary.simpleMessage('未配置任何更新服务器URL，请检查配置'),
    'updateCheckReleaseNotes': MessageLookupByLibrary.simpleMessage('更新内容：'),
    'updateCheckServerError': m30,
    'updateCheckServerTemporarilyUnavailable': MessageLookupByLibrary.simpleMessage('服务器暂时不可用，请稍后重试'),
    'updateCheckServerUrlNotConfigured': MessageLookupByLibrary.simpleMessage('未配置更新服务器URL，请检查配置'),
    ...
    'verificationCode6Digits': MessageLookupByLibrary.simpleMessage('验证码应为6位数字'),
    'verificationCodeSent': MessageLookupByLibrary.simpleMessage('验证码已发送到您的邮箱，请查收'),
    'verificationCodeSentCheckEmail': MessageLookupByLibrary.simpleMessage('验证码已发送，请查收邮箱'),
    ...
    'withdrawRequestSubmittedWaitReview': MessageLookupByLibrary.simpleMessage('提现申请已提交，请等待审核'),
    'withdrawSubmissionFailed': MessageLookupByLibrary.simpleMessage('提交失败'),
    'withdrawSubmissionFailedWithError': m33,
    'withdrawSubmissionNote': MessageLookupByLibrary.simpleMessage('提现申请将通过工单系统提交，请等待管理员审核。'),
    ...
    'xboard24HourCustomerService': MessageLookupByLibrary.simpleMessage('24小时客服支持'),
    ...
    'xboardAccountBannedDetail': MessageLookupByLibrary.simpleMessage('当前账号已被封禁，请联系客服处理。'),
    ...
    'xboardAddLinkToConfig': MessageLookupByLibrary.simpleMessage('在配置文件中添加此订阅链接'),
    'xboardAddingToConfigList': MessageLookupByLibrary.simpleMessage('添加到配置列表'),
    'xboardAfterPurchasingPlan': MessageLookupByLibrary.simpleMessage('购买套餐后您将享受：'),
    'xboardApiUrlNotConfigured': MessageLookupByLibrary.simpleMessage('API地址未配置'),
    'xboardAutoCheckEvery5Seconds': MessageLookupByLibrary.simpleMessage('系统每5秒自动检查一次，支付完成后会自动跳转'),
    'xboardAutoDetectPaymentStatus': MessageLookupByLibrary.simpleMessage('自动检测支付状态'),
    'xboardAutoOpeningPaymentPage': MessageLookupByLibrary.simpleMessage('正在自动打开支付页面，完成支付后请返回应用'),
    ...
    'xboardBrowserNotOpenedTip': MessageLookupByLibrary.simpleMessage('如果浏览器未自动打开，可以点击\\\"重新打开\\\"或复制链接手动打开'),
    'xboardBuyMoreTrafficOrUpgrade': MessageLookupByLibrary.simpleMessage('请购买更多流量或升级套餐'),
    ...
    'xboardCheckPaymentFailed': MessageLookupByLibrary.simpleMessage('检查支付状态失败'),
    ...
    'xboardCompletePaymentInBrowser': MessageLookupByLibrary.simpleMessage('2. 请在浏览器中完成支付操作'),
    'xboardConfigDownloadFailed': MessageLookupByLibrary.simpleMessage('配置文件下载失败，请检查订阅链接'),
    'xboardConfigFormatError': MessageLookupByLibrary.simpleMessage('配置文件格式错误，请联系服务提供商'),
    'xboardConfigSaveFailed': MessageLookupByLibrary.simpleMessage('保存配置失败，请检查存储空间'),
    ...
    'xboardCongratulationsSubscriptionActivated': MessageLookupByLibrary.simpleMessage('恭喜！您的套餐已成功购买并生效'),
    'xboardConnectGlobalQualityNodes': MessageLookupByLibrary.simpleMessage('连接全球优质节点'),
    'xboardConnectionTimeout': MessageLookupByLibrary.simpleMessage('连接超时，请检查网络连接'),
    'xboardContactCustomerService': MessageLookupByLibrary.simpleMessage('联系客服'),
    ...
    'xboardCopySubscriptionLinkAbove': MessageLookupByLibrary.simpleMessage('复制上方的订阅链接'),
    ...
    'xboardCreateTicketHint': MessageLookupByLibrary.simpleMessage('遇到问题可以创建工单联系客服。'),
    'xboardCreatedAt': MessageLookupByLibrary.simpleMessage('创建时间'),
    'xboardCreatingOrder': MessageLookupByLibrary.simpleMessage('正在创建订单'),
    'xboardCreatingOrderPleaseWait': MessageLookupByLibrary.simpleMessage('我们正在为您创建新订单，请稍候'),
    ...
    'xboardCustomRechargeAmount': MessageLookupByLibrary.simpleMessage('自定义充值金额'),
    'xboardDays': MessageLookupByLibrary.simpleMessage('天'),
    'xboardDeductedBalance': MessageLookupByLibrary.simpleMessage('已抵扣余额'),
    'xboardDeductibleDuringPayment': MessageLookupByLibrary.simpleMessage('支付时可抵扣'),
    'xboardDeviceAutoOfflineHint': MessageLookupByLibrary.simpleMessage('离线超过30天的设备会被自动移除'),
    'xboardDeviceCurrentDeviceLabel': MessageLookupByLibrary.simpleMessage('当前设备'),
    ...
    'xboardDeviceHistoryHint': MessageLookupByLibrary.simpleMessage('仅保留 90 天内的移除记录，超期设备将自动清理'),
    ...
    'xboardDeviceNoRecordsHint': MessageLookupByLibrary.simpleMessage('登录过的设备会显示在这里，方便你随时移除。'),
    'xboardDeviceOffline': MessageLookupByLibrary.simpleMessage('离线'),
    'xboardDeviceOnline': MessageLookupByLibrary.simpleMessage('在线'),
    'xboardDeviceRemoveCurrentConfirm': MessageLookupByLibrary.simpleMessage('这台设备是当前登录设备，移除后会立即退出登录。'),
    ...
    'xboardEnjoyFastNetworkExperience': MessageLookupByLibrary.simpleMessage('享受极速网络体验'),
    ...
    'xboardEnterGiftCardCode': MessageLookupByLibrary.simpleMessage('请输入礼品卡兑换码'),
    'xboardEnterGiftCardCodeHint': MessageLookupByLibrary.simpleMessage('请输入礼品卡兑换码'),
    ...
    'xboardFailedToCheckPaymentStatus': MessageLookupByLibrary.simpleMessage('检查支付状态失败'),
    'xboardFailedToGetSubscriptionInfo': MessageLookupByLibrary.simpleMessage('获取订阅信息失败'),
    'xboardFailedToOpenPaymentLink': MessageLookupByLibrary.simpleMessage('打开支付链接失败'),
    'xboardFailedToOpenPaymentPage': MessageLookupByLibrary.simpleMessage('打开支付页面失败'),
    ...
    'xboardGetGroupLinkFailed': MessageLookupByLibrary.simpleMessage('获取群组链接失败'),
    ...
    'xboardGroupLinkNotConfigured': MessageLookupByLibrary.simpleMessage('未配置群组链接'),
    ...
    'xboardImportingSubscription': MessageLookupByLibrary.simpleMessage('正在导入订阅'),
    'xboardInsufficientBalance': MessageLookupByLibrary.simpleMessage('余额不足'),
    'xboardInvalidCredentials': MessageLookupByLibrary.simpleMessage('用户名或密码错误'),
    'xboardInvalidOrExpiredCoupon': MessageLookupByLibrary.simpleMessage('优惠券代码无效或已过期'),
    'xboardInvalidResponseFormat': MessageLookupByLibrary.simpleMessage('服务器返回数据格式错误'),
    'xboardInviteCode': MessageLookupByLibrary.simpleMessage('邀请码'),
    'xboardJoinGroup': MessageLookupByLibrary.simpleMessage('加入群组'),
    'xboardKeepSubscriptionLinkSafe': MessageLookupByLibrary.simpleMessage('请妥善保管您的订阅链接，不要分享给他人'),
    'xboardLater': MessageLookupByLibrary.simpleMessage('稍后处理'),
    'xboardLoadingFailed': MessageLookupByLibrary.simpleMessage('加载失败'),
    'xboardLoadingPaymentPage': MessageLookupByLibrary.simpleMessage('正在加载支付页面'),
    ...
    'xboardLoginToViewSubscription': MessageLookupByLibrary.simpleMessage('请登录后查看套餐使用情况'),
    'xboardLogout': MessageLookupByLibrary.simpleMessage('退出登录'),
    'xboardLogoutConfirmContent': MessageLookupByLibrary.simpleMessage('确定要退出当前账户吗？退出后需要重新登录。'),
    ...
    'xboardMissingRequiredField': MessageLookupByLibrary.simpleMessage('缺少必要字段'),
    ...
    'xboardNetworkConnectionFailed': MessageLookupByLibrary.simpleMessage('网络连接失败，请检查网络设置'),
    ...
    'xboardNoAvailableSubscription': MessageLookupByLibrary.simpleMessage('无可用套餐'),
    'xboardNoInternetConnection': MessageLookupByLibrary.simpleMessage('无网络连接，请检查网络设置'),
    ...
    'xboardOpenPaymentLinkFailed': MessageLookupByLibrary.simpleMessage('打开支付链接失败'),
    ...
    'xboardPaymentInstructions1': MessageLookupByLibrary.simpleMessage('1. 系统已自动为您打开支付页面'),
    'xboardPaymentInstructions2': MessageLookupByLibrary.simpleMessage('2. 请在浏览器中完成支付操作'),
    'xboardPaymentInstructions3': MessageLookupByLibrary.simpleMessage('3. 支付完成后返回应用，系统将自动检测'),
    'xboardPaymentLink': MessageLookupByLibrary.simpleMessage('支付链接'),
    'xboardPaymentLinkCopied': MessageLookupByLibrary.simpleMessage('支付链接已复制到剪贴板'),
    'xboardPaymentMethodVerified': MessageLookupByLibrary.simpleMessage('支付方式验证通过'),
    'xboardPaymentMethodVerifiedPreparing': MessageLookupByLibrary.simpleMessage('支付方式已验证，准备跳转到支付页面'),
    'xboardPaymentMethods': MessageLookupByLibrary.simpleMessage('支付方式'),
    'xboardPaymentPageAutoOpened': MessageLookupByLibrary.simpleMessage('1. 系统已自动为您打开支付页面'),
    'xboardPaymentPageOpenedCompleteAndReturn': MessageLookupByLibrary.simpleMessage('支付页面已打开，请完成支付并返回应用'),
    'xboardPaymentPageOpenedInBrowser': MessageLookupByLibrary.simpleMessage('已在浏览器中打开支付页面，完成支付后请返回应用'),
    ...
    'xboardPlanExpiryReminder': MessageLookupByLibrary.simpleMessage('套餐到期邮件提醒'),
    ...
    'xboardPleaseEnterGiftCardCode': MessageLookupByLibrary.simpleMessage('请输入礼品卡码'),
    'xboardPleaseSelectPaymentPeriod': MessageLookupByLibrary.simpleMessage('请选择购买周期'),
    ...
    'xboardPreparingPaymentPage': MessageLookupByLibrary.simpleMessage('正在准备支付页面，即将跳转'),
    ...
    'xboardProtectNetworkPrivacy': MessageLookupByLibrary.simpleMessage('保护您的网络隐私'),
    'xboardProxy': MessageLookupByLibrary.simpleMessage('代理'),
    'xboardProxyMode': MessageLookupByLibrary.simpleMessage('代理模式'),
    'xboardProxyModeDirectDescription': MessageLookupByLibrary.simpleMessage('所有流量都直接连接，不使用代理'),
    'xboardProxyModeGlobalDescription': MessageLookupByLibrary.simpleMessage('所有流量都通过代理服务器'),
    'xboardProxyModeRuleDescription': MessageLookupByLibrary.simpleMessage('根据规则自动选择直连或代理'),
    ...
    'xboardPurchaseSubscriptionToUse': MessageLookupByLibrary.simpleMessage('请购买套餐后使用'),
    ...
    'xboardRechargeBalanceTip': MessageLookupByLibrary.simpleMessage('充值金额将进入账户余额，可用于购买套餐或支付订单。'),
    ...
    'xboardRegisterSuccess': MessageLookupByLibrary.simpleMessage('注册成功！正在跳转到登录页面...'),
    ...
    'xboardReopenPaymentPageTip': MessageLookupByLibrary.simpleMessage('如需重新打开，可点击下方\\\"重新打开\\\"按钮'),
    'xboardResetCurrentPlanTraffic': MessageLookupByLibrary.simpleMessage('重置当前套餐流量'),
    'xboardResetTraffic': MessageLookupByLibrary.simpleMessage('重置流量'),
    'xboardResetTrafficByPlanCycle': MessageLookupByLibrary.simpleMessage('按套餐周期重置流量'),
    'xboardResetTrafficConfirmContent': MessageLookupByLibrary.simpleMessage('此操作将重置已使用的流量，但不会增加套餐时长，是否继续？'),
    ...
    'xboardReturnAfterPaymentAutoDetect': MessageLookupByLibrary.simpleMessage('3. 支付完成后返回应用，系统将自动检测'),
    ...
    'xboardSelectRechargeAmount': MessageLookupByLibrary.simpleMessage('选择充值金额'),
    ...
    'xboardSubscriptionCopied': MessageLookupByLibrary.simpleMessage('订阅链接已复制到剪贴板'),
    'xboardSubscriptionExpired': MessageLookupByLibrary.simpleMessage('订阅已过期'),
    'xboardSubscriptionHasExpired': MessageLookupByLibrary.simpleMessage('订阅已过期'),
    ...
    'xboardSubscriptionLinkCopied': MessageLookupByLibrary.simpleMessage('订阅链接已复制到剪贴板'),
    ...
    'xboardTicketDescriptionHint': MessageLookupByLibrary.simpleMessage('请详细描述你遇到的问题'),
    ...
    'xboardTokenExpiredContent': MessageLookupByLibrary.simpleMessage('您的登录状态已过期，请重新登录以继续使用。'),
    ...
    'xboardTrafficExhaustedRenewConfirmContent': MessageLookupByLibrary.simpleMessage('续费套餐不会立即重置流量，如需立即使用可以重置流量或更换套餐，是否继续？'),
    'xboardTrafficLogHint': MessageLookupByLibrary.simpleMessage('仅显示近一个月的流量明细'),
    ...
    'xboardTwentyFourMonthCycle': MessageLookupByLibrary.simpleMessage('24个月周期'),
    'xboardTwoYearPayment': MessageLookupByLibrary.simpleMessage('两年付'),
    'xboardUnauthorizedAccess': MessageLookupByLibrary.simpleMessage('未授权访问，请先登录'),
    ...
    'xboardUnsupportedCouponType': MessageLookupByLibrary.simpleMessage('不支持的优惠券类型'),
    ...
    'xboardUpdateSubscriptionRegularly': MessageLookupByLibrary.simpleMessage('定期更新订阅获取最新节点'),
    ...
    'xboardValidatingConfigFormat': MessageLookupByLibrary.simpleMessage('验证配置格式'),
    ...
    'xboardWaitingPaymentCompletion': MessageLookupByLibrary.simpleMessage('等待支付完成'),
