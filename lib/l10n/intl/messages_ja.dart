...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(label) => "選択された${label}を削除してもよろしいですか？";

  static m2(label) => "現在の${label}を削除してもよろしいですか？";

  static m3(label) => "${label}は空欄にできません";

  static m4(label) => "現在の${label}は既に存在しています";

  static m5(error) => "ログアウト失敗：${error}";

  static m7(label) => "現在${label}はありません";

  static m8(label) => "${label}は数字でなければなりません";

  static m9(statusCode) => "メッセージの取得に失敗しました: ${statusCode}";

  static m10(error) => "画像の選択に失敗しました: ${error}";

  static m11(method) => "サポートされていないHTTPメソッド: ${method}";

  static m12(error) => "アップロードに失敗しました: ${error}";

  static m16(label) => "${label} は 1024 から 49151 の間でなければなりません";

  static m18(count) => "${count} 項目が選択されています";

  static m20(date) => "プランは${date}に期限切れになりました。継続利用には更新してください";

  static m21(days) => "プランは${days}日後に期限切れになります。タイムリーに更新してください";

  static m22(days) => "サブスクリプションは${days}日後に期限切れになります";

  static m27(version) => "現在のバージョン: ${version}";

  static m28(version) => "強制アップデート: ${version}";

  static m29(version) => "新しいバージョンが見つかりました: ${version}";

  static m30(statusCode) => "サーバーがエラーステータスコード ${statusCode} を返しました";

  static m31(label) => "${label}はURLである必要があります";

  static m33(error) => "送信に失敗しました: ${error}";

  static m35(amount) => "¥${amount}";

  static m36(count, limit) => "${count} 台アクティブ · 上限 ${limit}";

  static m37(date) => "Expired on ${date}";

  static m38(date) => "有効期限 ${date}";

  static m39(date, days) => "${date} に期限切れ、残り ${days} 日";

  static m40(error) => "交換失敗: ${error}";

  static m41(days) => "利用済み通信量は ${days} 日後にリセットされます";

  static m42(time) => "実行時間: ${time}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'accessControlAllowDesc': MessageLookupByLibrary.simpleMessage('選択したアプリのみVPNを許可'),
    'accessControlDesc': MessageLookupByLibrary.simpleMessage('アプリケーションのプロキシアクセスを設定'),
    'accessControlNotAllowDesc': MessageLookupByLibrary.simpleMessage('選択したアプリをVPNから除外'),
    ...
    'allowBypassDesc': MessageLookupByLibrary.simpleMessage('有効化すると一部アプリがVPNをバイパス'),
    ...
    'autoCheckUpdateDesc': MessageLookupByLibrary.simpleMessage('起動時に更新を自動チェック'),
    'autoCloseConnections': MessageLookupByLibrary.simpleMessage('接続を自動閉じる'),
    'autoCloseConnectionsDesc': MessageLookupByLibrary.simpleMessage('ノード変更後に接続を自動閉じる'),
    ...
    'backupAndRecoveryDesc': MessageLookupByLibrary.simpleMessage('WebDAVまたはファイルでデータを同期'),
    ...
    'cacheCorrupt': MessageLookupByLibrary.simpleMessage('キャッシュが破損しています。クリアしますか？'),
    'cancel': MessageLookupByLibrary.simpleMessage('キャンセル'),
    'cancelFilterSystemApp': MessageLookupByLibrary.simpleMessage('システムアプリの除外を解除'),
    ...
    'compatibleDesc': MessageLookupByLibrary.simpleMessage('有効化すると一部機能を失いますが、Clashの完全サポートを獲得'),
    'configurationError': MessageLookupByLibrary.simpleMessage('アプリケーション設定エラー、サポートにお問い合わせください'),
    ...
    'defaultNameserverDesc': MessageLookupByLibrary.simpleMessage('DNSサーバーの解決用'),
    ...
    'deleteMultipTip': m1,
    'deleteTip': m2,
    'desc': MessageLookupByLibrary.simpleMessage('ClashMetaベースのマルチプラットフォームプロキシクライアント'),
    ...
    'developerModeEnableTip': MessageLookupByLibrary.simpleMessage('デベロッパーモードが有効になりました。'),
    'direct': MessageLookupByLibrary.simpleMessage('ダイレクト'),
    'disclaimer': MessageLookupByLibrary.simpleMessage('重要なお知らせ'),
    'disclaimerDesc': MessageLookupByLibrary.simpleMessage('このソフトウェアは現在公開ベータ段階です。更新の通知を受け取った場合は、速やかに更新してください。古いバージョンではサービスが不安定になったり、使用できなくなる場合があります。'),
    ...
    'excludeDesc': MessageLookupByLibrary.simpleMessage('アプリがバックグラウンド時に最近のタスクから非表示'),
    'existsTip': m4,
    ...
    'externalControllerDesc': MessageLookupByLibrary.simpleMessage('有効化するとClashコアをポート9090で制御可能'),
    ...
    'fileIsUpdate': MessageLookupByLibrary.simpleMessage('ファイルが変更されました。保存しますか？'),
    ...
    'findProcessModeDesc': MessageLookupByLibrary.simpleMessage('有効化するとパフォーマンスが若干低下します'),
    ...
    'geodataLoaderDesc': MessageLookupByLibrary.simpleMessage('有効化するとGeo低メモリローダーを使用'),
    ...
    'hotkeyManagementDesc': MessageLookupByLibrary.simpleMessage('キーボードでアプリを制御'),
    ...
    'keepAliveIntervalDesc': MessageLookupByLibrary.simpleMessage('TCPキープアライブ間隔'),
    ...
    'logoutConfirmMsg': MessageLookupByLibrary.simpleMessage('現在のアカウントから退出しますか？再度ログインが必要です。'),
    'logoutFailed': m5,
    ...
    'minimizeOnExitDesc': MessageLookupByLibrary.simpleMessage('システムの終了イベントを変更'),
    ...
    'nameserverPolicyDesc': MessageLookupByLibrary.simpleMessage('対応するネームサーバーポリシーを指定'),
    ...
    'noProxyDesc': MessageLookupByLibrary.simpleMessage('プロファイルを作成するか、有効なプロファイルを追加してください'),
    'noResolve': MessageLookupByLibrary.simpleMessage('IPを解決しない'),
    'none': MessageLookupByLibrary.simpleMessage('なし'),
    'notConnected': MessageLookupByLibrary.simpleMessage('未接続'),
    'notSelectedTip': MessageLookupByLibrary.simpleMessage('現在のプロキシグループは選択できません'),
    'nullProfileDesc': MessageLookupByLibrary.simpleMessage('プロファイルがありません。追加してください'),
    'nullTip': m7,
    'numberTip': m8,
    ...
    'onlineSupportApiConfigNotFound': MessageLookupByLibrary.simpleMessage('オンラインサポートAPI設定が見つかりません。設定を確認してください'),
    ...
    'onlineSupportClearHistoryConfirm': MessageLookupByLibrary.simpleMessage('すべてのチャット履歴をクリアしてもよろしいですか？この操作は元に戻せません。'),
    'onlineSupportClickToSelect': MessageLookupByLibrary.simpleMessage('クリックして画像を選択'),
    'onlineSupportConfirm': MessageLookupByLibrary.simpleMessage('確認'),
    'onlineSupportConnected': MessageLookupByLibrary.simpleMessage('サポートシステムに正常に接続しました'),
    'onlineSupportConnecting': MessageLookupByLibrary.simpleMessage('接続中...'),
    'onlineSupportConnectionError': MessageLookupByLibrary.simpleMessage('接続エラー'),
    'onlineSupportDisconnected': MessageLookupByLibrary.simpleMessage('切断されました'),
    'onlineSupportGetMessagesFailed': m9,
    'onlineSupportInputHint': MessageLookupByLibrary.simpleMessage('ご質問を入力してください...'),
    'onlineSupportNoMessages': MessageLookupByLibrary.simpleMessage('メッセージがありません。メッセージを送信して相談を開始してください'),
    ...
    'onlineSupportSendMessageFailed': MessageLookupByLibrary.simpleMessage('メッセージの送信に失敗しました: 認証トークンを取得できません'),
    'onlineSupportSupportedFormats': MessageLookupByLibrary.simpleMessage('JPG、PNG、GIF、WebP、BMP対応\n最大10MB'),
    'onlineSupportTitle': MessageLookupByLibrary.simpleMessage('オンラインサポート'),
    'onlineSupportTokenNotFound': MessageLookupByLibrary.simpleMessage('認証トークンが見つかりません'),
    'onlineSupportUnsupportedHttpMethod': m11,
    'onlineSupportUploadFailed': m12,
    'onlineSupportWebSocketConfigNotFound': MessageLookupByLibrary.simpleMessage('オンラインサポートWebSocket設定が見つかりません。設定を確認してください'),
    ...
    'onlyStatisticsProxyDesc': MessageLookupByLibrary.simpleMessage('有効化するとプロキシトラフィックのみ統計'),
    ...
    'overrideDnsDesc': MessageLookupByLibrary.simpleMessage('有効化するとプロファイルのDNS設定を上書き'),
    'overrideInvalidTip': MessageLookupByLibrary.simpleMessage('スクリプトモードでは有効になりません'),
    ...
    'pleaseBindWebDAV': MessageLookupByLibrary.simpleMessage('WebDAVをバインドしてください'),
    'pleaseEnterScriptName': MessageLookupByLibrary.simpleMessage('スクリプト名を入力してください'),
    'pleaseEnterWithdrawAccount': MessageLookupByLibrary.simpleMessage('出金口座を入力してください'),
    'pleaseInputAdminPassword': MessageLookupByLibrary.simpleMessage('管理者パスワードを入力'),
    'pleaseSelectWithdrawMethod': MessageLookupByLibrary.simpleMessage('出金方法を選択してください'),
    'pleaseUploadFile': MessageLookupByLibrary.simpleMessage('ファイルをアップロードしてください'),
    'pleaseUploadValidQrcode': MessageLookupByLibrary.simpleMessage('有効なQRコードをアップロードしてください'),
    ...
    'profileAutoUpdateIntervalInvalidValidationDesc': MessageLookupByLibrary.simpleMessage('有効な間隔形式を入力してください'),
    'profileAutoUpdateIntervalNullValidationDesc': MessageLookupByLibrary.simpleMessage('自動更新間隔を入力してください'),
    'profileHasUpdate': MessageLookupByLibrary.simpleMessage('プロファイルが変更されました。自動更新を無効化しますか？'),
    'profileNameNullValidationDesc': MessageLookupByLibrary.simpleMessage('プロファイル名を入力してください'),
    'profileParseErrorDesc': MessageLookupByLibrary.simpleMessage('プロファイル解析エラー'),
    'profileUrlInvalidValidationDesc': MessageLookupByLibrary.simpleMessage('有効なプロファイルURLを入力してください'),
    'profileUrlNullValidationDesc': MessageLookupByLibrary.simpleMessage('プロファイルURLを入力してください'),
    ...
    'proxyNameserverDesc': MessageLookupByLibrary.simpleMessage('プロキシノード解決用ドメイン'),
    ...
    'recoveryStrategy_override': MessageLookupByLibrary.simpleMessage('オーバーライド'),
    ...
    'remoteBackupDesc': MessageLookupByLibrary.simpleMessage('WebDAVにデータをバックアップ'),
    'remoteRecoveryDesc': MessageLookupByLibrary.simpleMessage('WebDAVからデータを復元'),
    ...
    'respectRulesDesc': MessageLookupByLibrary.simpleMessage('DNS接続がルールに従う（proxy-server-nameserverの設定が必要）'),
    ...
    'routeMode_bypassPrivate': MessageLookupByLibrary.simpleMessage('プライベートルートをバイパス'),
    ...
    'subscriptionExpired': MessageLookupByLibrary.simpleMessage('サブスクリプションが期限切れです'),
    'subscriptionExpiredDetail': m20,
    'subscriptionExpiresToday': MessageLookupByLibrary.simpleMessage('サブスクリプションが本日期限切れ'),
    'subscriptionExpiresTodayDetail': MessageLookupByLibrary.simpleMessage('プランが本日期限切れになります。サービス中断を避けるため即座に更新してください'),
    'subscriptionExpiringInDays': MessageLookupByLibrary.simpleMessage('サブスクリプションがまもなく期限切れ'),
    'subscriptionExpiringInDaysDetail': m21,
    'subscriptionNoSubscription': MessageLookupByLibrary.simpleMessage('サブスクリプションがありません'),
    'subscriptionNoSubscriptionDetail': MessageLookupByLibrary.simpleMessage('利用可能なサブスクリプションプランが見つかりません。ご利用にはプランをご購入ください'),
    'subscriptionNotLoggedIn': MessageLookupByLibrary.simpleMessage('未ログイン'),
    'subscriptionNotLoggedInDetail': MessageLookupByLibrary.simpleMessage('まずログインしてください'),
    'subscriptionTrafficExhausted': MessageLookupByLibrary.simpleMessage('トラフィックを使い切りました'),
    'subscriptionTrafficExhaustedDetail': MessageLookupByLibrary.simpleMessage('プランのトラフィックを使い切りました。より多くのトラフィックを購入するかプランをアップグレードしてください'),
    ...
    'systemProxyDesc': MessageLookupByLibrary.simpleMessage('HTTPプロキシをVpnServiceに接続'),
    ...
    'unableToUpdateCurrentProfileDesc': MessageLookupByLibrary.simpleMessage('現在のプロファイルを更新できません'),
    'undo': MessageLookupByLibrary.simpleMessage('元に戻す'),
    'unifiedDelay': MessageLookupByLibrary.simpleMessage('統一遅延'),
    'unifiedDelayDesc': MessageLookupByLibrary.simpleMessage('ハンドシェイクなどの余分な遅延を削除'),
    'unknown': MessageLookupByLibrary.simpleMessage('不明'),
    'unnamed': MessageLookupByLibrary.simpleMessage('無題'),
    'update': MessageLookupByLibrary.simpleMessage('更新'),
    'updateCheckAllServersUnavailable': MessageLookupByLibrary.simpleMessage('設定されたすべてのアップデートサーバーが利用できません'),
    ...
    'updateCheckNoServerUrlsConfigured': MessageLookupByLibrary.simpleMessage('アップデートサーバーURLが設定されていません。設定を確認してください'),
    'updateCheckReleaseNotes': MessageLookupByLibrary.simpleMessage('リリースノート：'),
    'updateCheckServerError': m30,
    'updateCheckServerTemporarilyUnavailable': MessageLookupByLibrary.simpleMessage('サーバーが一時的に利用できません。しばらくしてから再試行してください'),
    'updateCheckServerUrlNotConfigured': MessageLookupByLibrary.simpleMessage('アップデートサーバーURLが設定されていません。設定を確認してください'),
    ...
    'vpnEnableDesc': MessageLookupByLibrary.simpleMessage('VpnService経由で全システムトラフィックをルーティング'),
    'vpnSystemProxyDesc': MessageLookupByLibrary.simpleMessage('HTTPプロキシをVpnServiceに接続'),
    ...
    'withdrawRequestSubmitted': MessageLookupByLibrary.simpleMessage('出金申請を送信しました'),
    'withdrawRequestSubmittedWaitReview': MessageLookupByLibrary.simpleMessage('出金申請を送信しました。確認をお待ちください'),
    'withdrawSubmissionFailed': MessageLookupByLibrary.simpleMessage('送信に失敗しました'),
    'withdrawSubmissionFailedWithError': m33,
    'withdrawSubmissionNote': MessageLookupByLibrary.simpleMessage('出金申請はチケットシステム経由で送信されます。管理者の確認をお待ちください。'),
    'xboard24HourCustomerService': MessageLookupByLibrary.simpleMessage('24時間カスタマーサービスサポート'),
    ...
    'xboardAddLinkToConfig': MessageLookupByLibrary.simpleMessage('設定にこのサブスクリプションリンクを追加'),
    'xboardAddingToConfigList': MessageLookupByLibrary.simpleMessage('設定リストに追加中'),
    'xboardAfterPurchasingPlan': MessageLookupByLibrary.simpleMessage('プラン購入後、あなたは以下を享受できます：'),
    'xboardApiUrlNotConfigured': MessageLookupByLibrary.simpleMessage('API URLが設定されていません'),
    'xboardAutoCheckEvery5Seconds': MessageLookupByLibrary.simpleMessage('システムが5秒ごとに自動チェックし、支払い完了後に自動リダイレクトします'),
    'xboardAutoDetectPaymentStatus': MessageLookupByLibrary.simpleMessage('支払い状況を自動検出'),
    'xboardAutoOpeningPaymentPage': MessageLookupByLibrary.simpleMessage('支払いページを自動的に開いています。支払い完了後はアプリに戻ってください'),
    ...
    'xboardBrowserNotOpenedTip': MessageLookupByLibrary.simpleMessage('ブラウザが自動的に開かない場合は、\\\"再開\\\"をクリックするかリンクを手動でコピーしてください'),
    'xboardBuyMoreTrafficOrUpgrade': MessageLookupByLibrary.simpleMessage('より多くのトラフィックを購入するかプランをアップグレードしてください'),
    ...
    'xboardCheckPaymentFailed': MessageLookupByLibrary.simpleMessage('支払い状況の確認に失敗しました'),
    ...
    'xboardCleaningOldConfig': MessageLookupByLibrary.simpleMessage('古い設定をクリーン中'),
    ...
    'xboardClickToSetupNodes': MessageLookupByLibrary.simpleMessage('クリックしてノードを設定'),
    ...
    'xboardCompletePaymentInBrowser': MessageLookupByLibrary.simpleMessage('2. ブラウザで支払いを完了してください'),
    'xboardConfigDownloadFailed': MessageLookupByLibrary.simpleMessage('設定のダウンロードに失敗しました、サブスクリプションリンクを確認してください'),
    'xboardConfigFormatError': MessageLookupByLibrary.simpleMessage('設定形式エラー、サービスプロバイダーにお問い合わせください'),
    'xboardConfigSaveFailed': MessageLookupByLibrary.simpleMessage('設定の保存に失敗しました、ストレージ容量を確認してください'),
    ...
    'xboardCongratulationsSubscriptionActivated': MessageLookupByLibrary.simpleMessage('おめでとうございます！サブスクリプションが正常に購入され、有効化されました'),
    'xboardConnectGlobalQualityNodes': MessageLookupByLibrary.simpleMessage('グローバル品質ノードに接続'),
    'xboardConnectionTimeout': MessageLookupByLibrary.simpleMessage('接続タイムアウト、ネットワーク接続を確認してください'),
    'xboardContactCustomerService': MessageLookupByLibrary.simpleMessage('カスタマーサービス'),
    ...
    'xboardCopySubscriptionLinkAbove': MessageLookupByLibrary.simpleMessage('上記のサブスクリプションリンクをコピー'),
    'xboardCouponExpired': MessageLookupByLibrary.simpleMessage('クーポンが期限切れです'),
    'xboardCouponNotYetActive': MessageLookupByLibrary.simpleMessage('クーポンはまだ有効ではありません'),
    ...
    'xboardCreatingOrderPleaseWait': MessageLookupByLibrary.simpleMessage('新しい注文を作成しています。お待ちください'),
    ...
    'xboardDeductibleDuringPayment': MessageLookupByLibrary.simpleMessage('支払い時に控除可能'),
    'xboardDeviceAutoOfflineHint': MessageLookupByLibrary.simpleMessage('30日以上オフラインのデバイスは自動的に削除されます。'),
    'xboardDeviceCurrentDeviceLabel': MessageLookupByLibrary.simpleMessage('現在のデバイス'),
    'xboardDeviceExpired': MessageLookupByLibrary.simpleMessage('期限切れ'),
    'xboardDeviceHistory': MessageLookupByLibrary.simpleMessage('履歴'),
    'xboardDeviceHistoryHint': MessageLookupByLibrary.simpleMessage('90日以内の削除記録のみ保持され、それ以前の記録は自動的に削除されます。'),
    ...
    'xboardDeviceLabelLastOnline': MessageLookupByLibrary.simpleMessage('最終オンライン'),
    'xboardDeviceLabelOsVersion': MessageLookupByLibrary.simpleMessage('OSバージョン'),
    ...
    'xboardDeviceNoRecordsHint': MessageLookupByLibrary.simpleMessage('ログインしたデバイスがここに表示されます。'),
    ...
    'xboardDeviceRemoveCurrentConfirm': MessageLookupByLibrary.simpleMessage('このデバイスは現在ログイン中のデバイスです。削除するとすぐにログアウトされます。'),
    ...
    'xboardDeviceUnknownVersion': MessageLookupByLibrary.simpleMessage('不明なバージョン'),
    ...
    'xboardDownloadingConfig': MessageLookupByLibrary.simpleMessage('設定ファイルをダウンロード中'),
    ...
    'xboardEnjoyFastNetworkExperience': MessageLookupByLibrary.simpleMessage('高速ネットワーク体験をお楽しみください'),
    ...
    'xboardEnterGiftCardCodeHint': MessageLookupByLibrary.simpleMessage('ギフトカード引換コードを入力'),
    ...
    'xboardFailedToCheckPaymentStatus': MessageLookupByLibrary.simpleMessage('支払い状況の確認に失敗しました'),
    'xboardFailedToGetSubscriptionInfo': MessageLookupByLibrary.simpleMessage('サブスクリプション情報の取得に失敗しました'),
    'xboardFailedToOpenPaymentLink': MessageLookupByLibrary.simpleMessage('支払いリンクを開けませんでした'),
    'xboardFailedToOpenPaymentPage': MessageLookupByLibrary.simpleMessage('支払いページを開けませんでした'),
    ...
    'xboardGetGroupLinkFailed': MessageLookupByLibrary.simpleMessage('グループリンク取得失敗'),
    ...
    'xboardGiftCardCodeLabel': MessageLookupByLibrary.simpleMessage('ギフトカードコード'),
    'xboardGiftCardRedeem': MessageLookupByLibrary.simpleMessage('Gift card redeem'),
    'xboardGiftCardRedeemTitle': MessageLookupByLibrary.simpleMessage('ギフトカード交換'),
    ...
    'xboardGroupLinkNotConfigured': MessageLookupByLibrary.simpleMessage('グループリンク未設定'),
    ...
    'xboardInvalidCredentials': MessageLookupByLibrary.simpleMessage('無効なユーザー名またはパスワード'),
    'xboardInvalidOrExpiredCoupon': MessageLookupByLibrary.simpleMessage('無効または期限切れのクーポンコード'),
    'xboardInvalidResponseFormat': MessageLookupByLibrary.simpleMessage('サーバーからの無効なレスポンス形式'),
    'xboardInviteCode': MessageLookupByLibrary.simpleMessage('招待コード'),
    'xboardJoinGroup': MessageLookupByLibrary.simpleMessage('グループ参加'),
    'xboardKeepSubscriptionLinkSafe': MessageLookupByLibrary.simpleMessage('サブスクリプションリンクを安全に保管し、他人と共有しないでください'),
    'xboardLater': MessageLookupByLibrary.simpleMessage('後で'),
    'xboardLoadingFailed': MessageLookupByLibrary.simpleMessage('読み込みに失敗しました'),
    'xboardLoadingPaymentPage': MessageLookupByLibrary.simpleMessage('支払いページを読み込み中'),
    ...
    'xboardLoginExpired': MessageLookupByLibrary.simpleMessage('ログインが期限切れです、再度ログインしてください'),
    ...
    'xboardLoginToViewSubscription': MessageLookupByLibrary.simpleMessage('サブスクリプション使用状況を確認するにはログインしてください'),
    'xboardLogout': MessageLookupByLibrary.simpleMessage('ログアウト'),
    'xboardLogoutConfirmContent': MessageLookupByLibrary.simpleMessage('現在のアカウントから退出しますか？再度ログインが必要です。'),
    ...
    'xboardMissingRequiredField': MessageLookupByLibrary.simpleMessage('必須フィールドが不足しています'),
    ...
    'xboardNetworkConnectionFailed': MessageLookupByLibrary.simpleMessage('ネットワーク接続に失敗しました、ネットワーク設定を確認してください'),
    'xboardNewVersionFound': MessageLookupByLibrary.simpleMessage('新しいバージョンが見つかりました'),
    'xboardNext': MessageLookupByLibrary.simpleMessage('次へ'),
    'xboardNoAvailableNodes': MessageLookupByLibrary.simpleMessage('利用可能なノードがありません'),
    'xboardNoAvailablePlan': MessageLookupByLibrary.simpleMessage('利用可能なプランがありません'),
    'xboardNoAvailableSubscription': MessageLookupByLibrary.simpleMessage('利用可能なサブスクリプションがありません'),
    'xboardNoInternetConnection': MessageLookupByLibrary.simpleMessage('インターネット接続がありません、ネットワーク設定を確認してください'),
    ...
    'xboardNoSubscriptionInfo': MessageLookupByLibrary.simpleMessage('サブスクリプション情報がありません'),
    'xboardNoSubscriptionPlans': MessageLookupByLibrary.simpleMessage('サブスクリプションプランがありません'),
    ...
    'xboardOpenPaymentFailed': MessageLookupByLibrary.simpleMessage('支払いページを開けませんでした'),
    'xboardOpenPaymentLinkFailed': MessageLookupByLibrary.simpleMessage('支払いリンクを開けませんでした'),
    ...
    'xboardOrderCreationFailed': MessageLookupByLibrary.simpleMessage('注文作成に失敗しました'),
    ...
    'xboardPaymentCancelled': MessageLookupByLibrary.simpleMessage('支払いがキャンセルされました'),
    ...
    'xboardPaymentInstructions1': MessageLookupByLibrary.simpleMessage('1. 支払いページが自動的に開かれました'),
    'xboardPaymentInstructions2': MessageLookupByLibrary.simpleMessage('2. ブラウザで支払いを完了してください'),
    'xboardPaymentInstructions3': MessageLookupByLibrary.simpleMessage('3. 支払い後にアプリに戻ると、システムが自動検出します'),
    'xboardPaymentLink': MessageLookupByLibrary.simpleMessage('支払いリンク'),
    'xboardPaymentLinkCopied': MessageLookupByLibrary.simpleMessage('支払いリンクをクリップボードにコピーしました'),
    'xboardPaymentMethodVerified': MessageLookupByLibrary.simpleMessage('支払い方法が確認されました'),
    'xboardPaymentMethodVerifiedPreparing': MessageLookupByLibrary.simpleMessage('支払い方法が確認されました。支払いページにリダイレクトする準備中です'),
    'xboardPaymentMethods': MessageLookupByLibrary.simpleMessage('Payment methods'),
    'xboardPaymentPageAutoOpened': MessageLookupByLibrary.simpleMessage('1. 支払いページが自動的に開かれました'),
    'xboardPaymentPageOpenedCompleteAndReturn': MessageLookupByLibrary.simpleMessage('支払いページが開かれました。支払いを完了してアプリに戻ってください'),
    'xboardPaymentPageOpenedInBrowser': MessageLookupByLibrary.simpleMessage('ブラウザで支払いページが開かれました。支払い完了後はアプリに戻ってください'),
    'xboardPaymentSuccess': MessageLookupByLibrary.simpleMessage('支払い成功'),
    'xboardPaymentSuccessful': MessageLookupByLibrary.simpleMessage('🎉 支払い成功！'),
    ...
    'xboardPlanExpiryReminder': MessageLookupByLibrary.simpleMessage('プラン期限切れメール通知'),
    ...
    'xboardPleaseEnterGiftCardCode': MessageLookupByLibrary.simpleMessage('ギフトカードコードを入力してください'),
    'xboardPleaseSelectPaymentPeriod': MessageLookupByLibrary.simpleMessage('支払い期間を選択してください'),
    ...
    'xboardPreparingPaymentPage': MessageLookupByLibrary.simpleMessage('支払いページを準備中、まもなくリダイレクトします'),
    ...
    'xboardProfessionalSupport': MessageLookupByLibrary.simpleMessage('プロフェッショナルサポート'),
    'xboardProfile': MessageLookupByLibrary.simpleMessage('プロファイル'),
    'xboardProtectNetworkPrivacy': MessageLookupByLibrary.simpleMessage('ネットワークプライバシーを保護'),
    'xboardProxy': MessageLookupByLibrary.simpleMessage('プロキシ'),
    'xboardProxyMode': MessageLookupByLibrary.simpleMessage('プロキシモード'),
    'xboardProxyModeDirectDescription': MessageLookupByLibrary.simpleMessage('すべてのトラフィックがプロキシなしで直接接続'),
    'xboardProxyModeGlobalDescription': MessageLookupByLibrary.simpleMessage('すべてのトラフィックがプロキシサーバーを通過'),
    'xboardProxyModeRuleDescription': MessageLookupByLibrary.simpleMessage('ルールに基づいて直接またはプロキシを自動選択'),
    'xboardPurchasePlan': MessageLookupByLibrary.simpleMessage('プランを購入'),
    'xboardPurchaseSubscription': MessageLookupByLibrary.simpleMessage('サブスクリプション購入'),
    'xboardPurchaseSubscriptionToUse': MessageLookupByLibrary.simpleMessage('使用するにはサブスクリプションを購入してください'),
    ...
    'xboardRegisterSuccess': MessageLookupByLibrary.simpleMessage('登録成功！ログインページにリダイレクトしています...'),
    ...
    'xboardRenewToContinue': MessageLookupByLibrary.simpleMessage('引き続き使用するには更新してください'),
    'xboardReopen': MessageLookupByLibrary.simpleMessage('再開'),
    'xboardReopenPayment': MessageLookupByLibrary.simpleMessage('支払いを再開'),
    'xboardReopenPaymentPageTip': MessageLookupByLibrary.simpleMessage('再度開くには、下の\\\"再開\\\"ボタンをクリックしてください'),
    ...
    'xboardResetTrafficConfirmContent': MessageLookupByLibrary.simpleMessage('この操作により使用済みトラフィックがリセットされますが、プラン期間は延長されません。続行しますか？'),
    ...
    'xboardReturnAfterPaymentAutoDetect': MessageLookupByLibrary.simpleMessage('3. 支払い後にアプリに戻ると、システムが自動検出します'),
    'xboardRunningTime': m42,
    'xboardSecureEncryption': MessageLookupByLibrary.simpleMessage('セキュア暗号化'),
    'xboardSelectPaymentPeriod': MessageLookupByLibrary.simpleMessage('支払い期間を選択'),
    ...
    'xboardSendVerificationCode': MessageLookupByLibrary.simpleMessage('認証コードを送信'),
    ...
    'xboardSubscriptionCopied': MessageLookupByLibrary.simpleMessage('サブスクリプションリンクをクリップボードにコピーしました'),
    'xboardSubscriptionExpired': MessageLookupByLibrary.simpleMessage('サブスクリプションが期限切れです'),
    'xboardSubscriptionHasExpired': MessageLookupByLibrary.simpleMessage('サブスクリプションが期限切れです'),
    'xboardSubscriptionInfo': MessageLookupByLibrary.simpleMessage('サブスクリプション情報'),
    'xboardSubscriptionLink': MessageLookupByLibrary.simpleMessage('サブスクリプションリンク'),
    'xboardSubscriptionLinkCopied': MessageLookupByLibrary.simpleMessage('サブスクリプションリンクをクリップボードにコピーしました'),
    'xboardSubscriptionPurchase': MessageLookupByLibrary.simpleMessage('サブスクリプション購入'),
    'xboardSubscriptionStatus': MessageLookupByLibrary.simpleMessage('サブスクリプションステータス'),
    ...
    'xboardThirtySixMonthCycle': MessageLookupByLibrary.simpleMessage('36ヶ月サイクル'),
    ...
    'xboardTokenExpiredContent': MessageLookupByLibrary.simpleMessage('ログインセッションが期限切れです。続行するには再度ログインしてください。'),
    ...
    'xboardTrafficExhausted': MessageLookupByLibrary.simpleMessage('トラフィックを使い切りました'),
    'xboardTrafficExhaustedRenewConfirmContent': MessageLookupByLibrary.simpleMessage('プランを更新しても通信量はすぐにはリセットされません。すぐに利用するには、通信量をリセットするかプランを変更してください。続行しますか？'),
    'xboardTrafficLogHint': MessageLookupByLibrary.simpleMessage('過去1か月分のトラフィックのみ表示'),
    'xboardTrafficReminder': MessageLookupByLibrary.simpleMessage('トラフィック使用量メール通知'),
    'xboardTrafficUsedUp': MessageLookupByLibrary.simpleMessage('トラフィックを使い切りました'),
    ...
    'xboardTwentyFourMonthCycle': MessageLookupByLibrary.simpleMessage('24ヶ月サイクル'),
    'xboardTwoYearPayment': MessageLookupByLibrary.simpleMessage('2年払い'),
    'xboardUnauthorizedAccess': MessageLookupByLibrary.simpleMessage('認証されていないアクセス、まずログインしてください'),
    'xboardUnknownErrorRetry': MessageLookupByLibrary.simpleMessage('不明なエラー、再試行してください'),
    ...
    'xboardUnsupportedCouponType': MessageLookupByLibrary.simpleMessage('サポートされていないクーポンタイプ'),
    ...
    'xboardUpdateSubscriptionRegularly': MessageLookupByLibrary.simpleMessage('定期的にサブスクリプションを更新して最新のノードを取得'),
    ...
    'xboardValidatingConfigFormat': MessageLookupByLibrary.simpleMessage('設定形式を検証中'),
    ...
    'xboardWaitingForPayment': MessageLookupByLibrary.simpleMessage('支払いを待っています'),
    'xboardWaitingPaymentCompletion': MessageLookupByLibrary.simpleMessage('支払い完了を待機中'),
