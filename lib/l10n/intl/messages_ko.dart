...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(rate) => "현재 커미션 rate: ${rate}";

  static m1(label) => "삭제 multip 안내: ${label}";

  static m2(label) => "삭제 안내: ${label}";

  static m3(label) => "비어 있음 안내: ${label}";

  static m4(label) => "exists 안내: ${label}";

  static m5(error) => "로그아웃 실패: ${error}";

  static m6(amount) => "MAX transferable: ${amount}";

  static m7(label) => "없음 안내: ${label}";

  static m8(label) => "number 안내: ${label}";

  static m9(statusCode) => "메시지 가져오기 실패: ${statusCode}";

  static m10(error) => "지원 선택 이미지 실패: ${error}";

  static m11(method) => "지원하지 않는 HTTP 메서드: ${method}";

  static m12(error) => "지원 업로드 실패: ${error}";

  static m13(amount) => "주문 금액: ${amount}";

  static m14(orderNo) => "주문 number: ${orderNo}";

  static m15(page) => "page number: ${page}";

  static m16(label) => "포트 안내: ${label}";

  static m17(e) => "registration 실패: ${e}";

  static m18(count) => "선택됨 count 제목: ${count}";

  static m19(e) => "보내기 인증 코드 실패: ${e}";

  static m20(date) => "구독 만료됨 상세: ${date}";

  static m21(days) => "구독 expiring IN 일 상세: ${days}";

  static m22(days) => "구독 유효 상세: ${days}";

  static m23(count) => "전체 기록: ${count}";

  static m24(amount) => "이체 금액 exceeded: ${amount}";

  static m25(error) => "이체 실패: ${error}";

  static m26(amount) => "이체 성공 MSG: ${amount}";

  static m27(version) => "업데이트 확인 현재 버전: ${version}";

  static m28(version) => "업데이트 확인 force 업데이트: ${version}";

  static m29(version) => "업데이트 확인 새 버전 found: ${version}";

  static m30(statusCode) => "업데이트 확인 서버 오류: ${statusCode}";

  static m31(label) => "URL 안내: ${label}";

  static m32(email) => "인증 코드 sent TO: ${email}";

  static m33(error) => "출금 submission 실패 with 오류: ${error}";

  static m34(amount) => "withdrawable 금액: ${amount}";

  static m35(amount) => "잔액 with 금액: ${amount}";

  static m36(count, limit) => "기기 summary: ${count}: ${limit}";

  static m37(date) => "만료됨 ON date: ${date}";

  static m38(date) => "만료 ON date: ${date}";

  static m39(date, days) => "만료 ON with 일: ${date}: ${days}";

  static m40(error) => "redeem 실패 with 오류: ${error}";

  static m41(days) => "초기화 트래픽 IN 일: ${days}";

  static m42(time) => "실행 중 time: ${time}";
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'accessControlAllowDesc': MessageLookupByLibrary.simpleMessage('access control 허용 설명'),
    'accessControlDesc': MessageLookupByLibrary.simpleMessage('access control 설명'),
    'accessControlNotAllowDesc': MessageLookupByLibrary.simpleMessage('access control NOT 허용 설명'),
    ...
    'addedOriginRules': MessageLookupByLibrary.simpleMessage('added origin rules'),
    ...
    'alreadyHaveAccount': MessageLookupByLibrary.simpleMessage('already have 계정'),
    'app': MessageLookupByLibrary.simpleMessage('앱'),
    'appAccessControl': MessageLookupByLibrary.simpleMessage('앱 access control'),
    ...
    'autoCheckUpdateDesc': MessageLookupByLibrary.simpleMessage('자동 확인 업데이트 설명'),
    'autoCloseConnections': MessageLookupByLibrary.simpleMessage('자동 닫기 connections'),
    'autoCloseConnectionsDesc': MessageLookupByLibrary.simpleMessage('자동 닫기 connections 설명'),
    ...
    'autoUpdateInterval': MessageLookupByLibrary.simpleMessage('자동 업데이트 interval'),
    ...
    'backupAndRecovery': MessageLookupByLibrary.simpleMessage('백업 AND recovery'),
    'backupAndRecoveryDesc': MessageLookupByLibrary.simpleMessage('백업 AND recovery 설명'),
    ...
    'cancelFilterSystemApp': MessageLookupByLibrary.simpleMessage('취소 filter 시스템 앱'),
    'cancelSelectAll': MessageLookupByLibrary.simpleMessage('취소 선택 ALL'),
    'cannotGetWebUrl': MessageLookupByLibrary.simpleMessage('웹 주소를 가져올 수 없습니다. 고객지원에 문의하세요'),
    ...
    'completeWithdrawal': MessageLookupByLibrary.simpleMessage('complete withdrawal'),
    'configurationError': MessageLookupByLibrary.simpleMessage('앱 설정 오류입니다. 고객지원에 문의하세요'),
    ...
    'defaultNameserverDesc': MessageLookupByLibrary.simpleMessage('기본값 nameserver 설명'),
    ...
    'developerModeEnableTip': MessageLookupByLibrary.simpleMessage('developer 모드 활성화 안내'),
    ...
    'domainStatusAvailable': MessageLookupByLibrary.simpleMessage('도메인 상태 사용 가능'),
    'domainStatusChecking': MessageLookupByLibrary.simpleMessage('도메인 상태 확인 중'),
    'domainStatusUnavailable': MessageLookupByLibrary.simpleMessage('도메인 상태 사용 불가'),
    ...
    'enterEmailForReset': MessageLookupByLibrary.simpleMessage('enter 이메일 FOR 초기화'),
    'enterTransferAmount': MessageLookupByLibrary.simpleMessage('enter 이체 금액'),
    'enterTransferAmountError': MessageLookupByLibrary.simpleMessage('enter 이체 금액 오류'),
    ...
    'expressiveScheme': MessageLookupByLibrary.simpleMessage('expressive scheme'),
    'externalController': MessageLookupByLibrary.simpleMessage('외부 controller'),
    'externalControllerDesc': MessageLookupByLibrary.simpleMessage('외부 controller 설명'),
    ...
    'findProcessModeDesc': MessageLookupByLibrary.simpleMessage('find process 모드 설명'),
    ...
    'friendInviteReward': MessageLookupByLibrary.simpleMessage('friend 초대 reward'),
    'fruitSaladScheme': MessageLookupByLibrary.simpleMessage('fruit salad scheme'),
    ...
    'geodataLoaderDesc': MessageLookupByLibrary.simpleMessage('geodata loader 설명'),
    ...
    'hotkeyManagementDesc': MessageLookupByLibrary.simpleMessage('hotkey 관리 설명'),
    ...
    'inputCorrectHotkey': MessageLookupByLibrary.simpleMessage('입력 correct hotkey'),
    'intelligentSelected': MessageLookupByLibrary.simpleMessage('intelligent 선택됨'),
    'internet': MessageLookupByLibrary.simpleMessage('internet'),
    'interval': MessageLookupByLibrary.simpleMessage('interval'),
    'intranetIP': MessageLookupByLibrary.simpleMessage('intranet IP'),
    'invalidTransferAmount': MessageLookupByLibrary.simpleMessage('유효하지 않음 이체 금액'),
    ...
    'inviteCodeIncorrect': MessageLookupByLibrary.simpleMessage('초대 코드 incorrect'),
    'inviteCodeOptional': MessageLookupByLibrary.simpleMessage('초대 코드 optional'),
    'inviteCodeRequired': MessageLookupByLibrary.simpleMessage('초대 코드 필수'),
    'inviteCodeRequiredMessage': MessageLookupByLibrary.simpleMessage('초대 코드 필수 메시지'),
    'inviteLinkCopied': MessageLookupByLibrary.simpleMessage('초대 링크 복사됨'),
    'inviteRegisterReward': MessageLookupByLibrary.simpleMessage('초대 가입 reward'),
    ...
    'keepAliveIntervalDesc': MessageLookupByLibrary.simpleMessage('keep alive interval 설명'),
    ...
    'monochromeScheme': MessageLookupByLibrary.simpleMessage('monochrome scheme'),
    ...
    'nameserverPolicyDesc': MessageLookupByLibrary.simpleMessage('nameserver 정책 설명'),
    ...
    'onlineSupportApiConfigNotFound': MessageLookupByLibrary.simpleMessage('온라인 지원 API 설정을 찾을 수 없습니다. 설정을 확인하세요'),
    ...
    'onlineSupportClearHistoryConfirm': MessageLookupByLibrary.simpleMessage('모든 채팅 기록을 지우시겠습니까? 이 작업은 되돌릴 수 없습니다.'),
    'onlineSupportClickToSelect': MessageLookupByLibrary.simpleMessage('클릭하여 이미지 선택'),
    'onlineSupportConfirm': MessageLookupByLibrary.simpleMessage('확인'),
    'onlineSupportConnected': MessageLookupByLibrary.simpleMessage('지원 시스템에 연결되었습니다'),
    'onlineSupportConnecting': MessageLookupByLibrary.simpleMessage('연결 중...'),
    'onlineSupportConnectionError': MessageLookupByLibrary.simpleMessage('연결 오류'),
    'onlineSupportDisconnected': MessageLookupByLibrary.simpleMessage('연결 해제됨'),
    'onlineSupportGetMessagesFailed': m9,
    'onlineSupportInputHint': MessageLookupByLibrary.simpleMessage('질문을 입력하세요...'),
    'onlineSupportNoMessages': MessageLookupByLibrary.simpleMessage('아직 메시지가 없습니다. 메시지를 보내 상담을 시작하세요'),
    ...
    'onlineSupportSendMessageFailed': MessageLookupByLibrary.simpleMessage('메시지 전송 실패: 인증 토큰을 가져올 수 없습니다'),
    'onlineSupportSupportedFormats': MessageLookupByLibrary.simpleMessage('JPG, PNG, GIF, WebP, BMP 지원\n최대 10MB'),
    'onlineSupportTitle': MessageLookupByLibrary.simpleMessage('온라인 지원'),
    'onlineSupportTokenNotFound': MessageLookupByLibrary.simpleMessage('인증 토큰을 찾을 수 없습니다'),
    'onlineSupportUnsupportedHttpMethod': m11,
    'onlineSupportUploadFailed': m12,
    'onlineSupportWebSocketConfigNotFound': MessageLookupByLibrary.simpleMessage('온라인 지원 WebSocket 설정을 찾을 수 없습니다. 설정을 확인하세요'),
    ...
    'onlyStatisticsProxyDesc': MessageLookupByLibrary.simpleMessage('만 통계 프록시 설명'),
    'openWebFailed': MessageLookupByLibrary.simpleMessage('열기 웹 실패'),
    'options': MessageLookupByLibrary.simpleMessage('options'),
    'orderAmount': m13,
    'orderNumber': m14,
    'other': MessageLookupByLibrary.simpleMessage('기타'),
    'otherContributors': MessageLookupByLibrary.simpleMessage('기타 contributors'),
    ...
    'overrideInvalidTip': MessageLookupByLibrary.simpleMessage('오버라이드 유효하지 않음 안내'),
    'overrideOriginRules': MessageLookupByLibrary.simpleMessage('오버라이드 origin rules'),
    'pageNumber': m15,
    'palette': MessageLookupByLibrary.simpleMessage('palette'),
    'password': MessageLookupByLibrary.simpleMessage('비밀번호'),
    'passwordMin8Chars': MessageLookupByLibrary.simpleMessage('비밀번호 MIN 8 chars'),
    'passwordMinLength': MessageLookupByLibrary.simpleMessage('비밀번호 MIN length'),
    ...
    'passwordResetSuccessful': MessageLookupByLibrary.simpleMessage('비밀번호 초기화 성공'),
    ...
    'pleaseBindWebDAV': MessageLookupByLibrary.simpleMessage('please bind 웹 DAV'),
    'pleaseConfirmNewPassword': MessageLookupByLibrary.simpleMessage('please 확인 새 비밀번호'),
    'pleaseConfirmPassword': MessageLookupByLibrary.simpleMessage('please 확인 비밀번호'),
    'pleaseEnterAtLeast8CharsPassword': MessageLookupByLibrary.simpleMessage('please enter AT least 8 chars 비밀번호'),
    'pleaseEnterEmail': MessageLookupByLibrary.simpleMessage('please enter 이메일'),
    'pleaseEnterEmailAddress': MessageLookupByLibrary.simpleMessage('please enter 이메일 주소'),
    'pleaseEnterEmailVerificationCode': MessageLookupByLibrary.simpleMessage('please enter 이메일 인증 코드'),
    'pleaseEnterInviteCode': MessageLookupByLibrary.simpleMessage('please enter 초대 코드'),
    'pleaseEnterNewPassword': MessageLookupByLibrary.simpleMessage('please enter 새 비밀번호'),
    'pleaseEnterPassword': MessageLookupByLibrary.simpleMessage('please enter 비밀번호'),
    'pleaseEnterScriptName': MessageLookupByLibrary.simpleMessage('please enter 스크립트 이름'),
    'pleaseEnterValidEmail': MessageLookupByLibrary.simpleMessage('please enter 유효 이메일'),
    'pleaseEnterValidEmailAddress': MessageLookupByLibrary.simpleMessage('please enter 유효 이메일 주소'),
    'pleaseEnterValidVerificationCode': MessageLookupByLibrary.simpleMessage('please enter 유효 인증 코드'),
    'pleaseEnterVerificationCode': MessageLookupByLibrary.simpleMessage('please enter 인증 코드'),
    'pleaseEnterWithdrawAccount': MessageLookupByLibrary.simpleMessage('please enter 출금 계정'),
    'pleaseEnterYourEmailAddress': MessageLookupByLibrary.simpleMessage('please enter your 이메일 주소'),
    'pleaseInputAdminPassword': MessageLookupByLibrary.simpleMessage('please 입력 관리자 비밀번호'),
    'pleaseReEnterPassword': MessageLookupByLibrary.simpleMessage('please RE enter 비밀번호'),
    'pleaseSelectWithdrawMethod': MessageLookupByLibrary.simpleMessage('please 선택 출금 방식'),
    'pleaseUploadFile': MessageLookupByLibrary.simpleMessage('please 업로드 파일'),
    'pleaseUploadValidQrcode': MessageLookupByLibrary.simpleMessage('please 업로드 유효 QR 코드'),
    ...
    'profileAutoUpdateIntervalInvalidValidationDesc': MessageLookupByLibrary.simpleMessage('프로필 자동 업데이트 interval 유효하지 않음 validation 설명'),
    'profileAutoUpdateIntervalNullValidationDesc': MessageLookupByLibrary.simpleMessage('프로필 자동 업데이트 interval 없음 validation 설명'),
    'profileHasUpdate': MessageLookupByLibrary.simpleMessage('프로필 HAS 업데이트'),
    'profileNameNullValidationDesc': MessageLookupByLibrary.simpleMessage('프로필 이름 없음 validation 설명'),
    'profileParseErrorDesc': MessageLookupByLibrary.simpleMessage('프로필 parse 오류 설명'),
    'profileUrlInvalidValidationDesc': MessageLookupByLibrary.simpleMessage('프로필 URL 유효하지 않음 validation 설명'),
    'profileUrlNullValidationDesc': MessageLookupByLibrary.simpleMessage('프로필 URL 없음 validation 설명'),
    ...
    'proxyNameserverDesc': MessageLookupByLibrary.simpleMessage('프록시 nameserver 설명'),
    ...
    'recoveryStrategy_compatible': MessageLookupByLibrary.simpleMessage('recovery strategy compatible'),
    'recoveryStrategy_override': MessageLookupByLibrary.simpleMessage('recovery strategy 오버라이드'),
    ...
    'registerSuccessSaveCredentials': MessageLookupByLibrary.simpleMessage('가입 성공 저장 credentials'),
    ...
    'remoteRecoveryDesc': MessageLookupByLibrary.simpleMessage('원격 recovery 설명'),
    ...
    'resendVerificationCode': MessageLookupByLibrary.simpleMessage('resend 인증 코드'),
    ...
    'respectRulesDesc': MessageLookupByLibrary.simpleMessage('respect rules 설명'),
    ...
    'routeMode_bypassPrivate': MessageLookupByLibrary.simpleMessage('라우팅 모드 bypass private'),
    ...
    'saveQrCodeFeature': MessageLookupByLibrary.simpleMessage('저장 QR 코드 feature'),
    ...
    'subscriptionExpiresToday': MessageLookupByLibrary.simpleMessage('구독 만료 오늘'),
    'subscriptionExpiresTodayDetail': MessageLookupByLibrary.simpleMessage('구독 만료 오늘 상세'),
    'subscriptionExpiringInDays': MessageLookupByLibrary.simpleMessage('구독 expiring IN 일'),
    'subscriptionExpiringInDaysDetail': m21,
    'subscriptionNoSubscription': MessageLookupByLibrary.simpleMessage('구독 없음 구독'),
    'subscriptionNoSubscriptionDetail': MessageLookupByLibrary.simpleMessage('구독 없음 구독 상세'),
    'subscriptionNotLoggedIn': MessageLookupByLibrary.simpleMessage('구독 NOT logged IN'),
    'subscriptionNotLoggedInDetail': MessageLookupByLibrary.simpleMessage('구독 NOT logged IN 상세'),
    'subscriptionTrafficExhausted': MessageLookupByLibrary.simpleMessage('구독 트래픽 exhausted'),
    'subscriptionTrafficExhaustedDetail': MessageLookupByLibrary.simpleMessage('구독 트래픽 exhausted 상세'),
    ...
    'tabAnimationDesc': MessageLookupByLibrary.simpleMessage('TAB animation 설명'),
    'tapToConnect': MessageLookupByLibrary.simpleMessage('탭하여 연결'),
    'tcpConcurrent': MessageLookupByLibrary.simpleMessage('TCP 동시 연결'),
    'tcpConcurrentDesc': MessageLookupByLibrary.simpleMessage('TCP concurrent 설명'),
    ...
    'tonalSpotScheme': MessageLookupByLibrary.simpleMessage('tonal spot scheme'),
    ...
    'unableToUpdateCurrentProfileDesc': MessageLookupByLibrary.simpleMessage('unable TO 업데이트 현재 프로필 설명'),
    ...
    'updateCheckAllServersUnavailable': MessageLookupByLibrary.simpleMessage('업데이트 확인 ALL servers 사용 불가'),
    'updateCheckCurrentVersion': m27,
    'updateCheckForceUpdate': m28,
    'updateCheckMustUpdate': MessageLookupByLibrary.simpleMessage('업데이트 확인 must 업데이트'),
    'updateCheckNewVersionFound': m29,
    'updateCheckNoServerUrlsConfigured': MessageLookupByLibrary.simpleMessage('업데이트 확인 없음 서버 URL configured'),
    'updateCheckReleaseNotes': MessageLookupByLibrary.simpleMessage('업데이트 확인 release notes'),
    'updateCheckServerError': m30,
    'updateCheckServerTemporarilyUnavailable': MessageLookupByLibrary.simpleMessage('업데이트 확인 서버 temporarily 사용 불가'),
    'updateCheckServerUrlNotConfigured': MessageLookupByLibrary.simpleMessage('업데이트 확인 서버 URL NOT configured'),
    'updateCheckUpdateLater': MessageLookupByLibrary.simpleMessage('업데이트 확인 업데이트 later'),
    'updateCheckUpdateNow': MessageLookupByLibrary.simpleMessage('업데이트 확인 업데이트 NOW'),
    ...
    'verificationCode6Digits': MessageLookupByLibrary.simpleMessage('인증 코드 6 digits'),
    'verificationCodeSent': MessageLookupByLibrary.simpleMessage('인증 코드 sent'),
    'verificationCodeSentCheckEmail': MessageLookupByLibrary.simpleMessage('인증 코드 sent 확인 이메일'),
    ...
    'vpnSystemProxyDesc': MessageLookupByLibrary.simpleMessage('VPN 시스템 프록시 설명'),
    ...
    'webDAVConfiguration': MessageLookupByLibrary.simpleMessage('웹 davconfiguration'),
    ...
    'withdrawRequestSubmitted': MessageLookupByLibrary.simpleMessage('출금 request submitted'),
    'withdrawRequestSubmittedWaitReview': MessageLookupByLibrary.simpleMessage('출금 request submitted wait review'),
    'withdrawSubmissionFailed': MessageLookupByLibrary.simpleMessage('출금 submission 실패'),
    'withdrawSubmissionFailedWithError': m33,
    'withdrawSubmissionNote': MessageLookupByLibrary.simpleMessage('출금 submission note'),
    'withdrawableAmount': m34,
    'withdrawalAvailable': MessageLookupByLibrary.simpleMessage('withdrawal 사용 가능'),
    'xboard': MessageLookupByLibrary.simpleMessage('XBoard'),
    'xboard24HourCustomerService': MessageLookupByLibrary.simpleMessage('24 시간 고객 서비스'),
    ...
    'xboardAccountBannedDetail': MessageLookupByLibrary.simpleMessage('계정 banned 상세'),
    ...
    'xboardAddLinkToConfig': MessageLookupByLibrary.simpleMessage('추가 링크 TO 설정'),
    'xboardAddingToConfigList': MessageLookupByLibrary.simpleMessage('adding TO 설정 목록'),
    'xboardAfterPurchasingPlan': MessageLookupByLibrary.simpleMessage('after purchasing 요금제'),
    'xboardApiUrlNotConfigured': MessageLookupByLibrary.simpleMessage('API URL NOT configured'),
    'xboardAutoCheckEvery5Seconds': MessageLookupByLibrary.simpleMessage('자동 확인 every 5 초'),
    'xboardAutoDetectPaymentStatus': MessageLookupByLibrary.simpleMessage('자동 detect 결제 상태'),
    'xboardAutoOpeningPaymentPage': MessageLookupByLibrary.simpleMessage('자동 opening 결제 page'),
    ...
    'xboardBrowserNotOpenedTip': MessageLookupByLibrary.simpleMessage('브라우저 NOT opened 안내'),
    'xboardBuyMoreTrafficOrUpgrade': MessageLookupByLibrary.simpleMessage('BUY 더보기 트래픽 OR upgrade'),
    ...
    'xboardCheckPaymentFailed': MessageLookupByLibrary.simpleMessage('확인 결제 실패'),
    'xboardCheckPaymentStatus': MessageLookupByLibrary.simpleMessage('확인 결제 상태'),
    'xboardCheckStatus': MessageLookupByLibrary.simpleMessage('확인 상태'),
    'xboardChecking': MessageLookupByLibrary.simpleMessage('확인 중'),
    'xboardCleaningOldConfig': MessageLookupByLibrary.simpleMessage('cleaning 이전 설정'),
    ...
    'xboardClickToSetupNodes': MessageLookupByLibrary.simpleMessage('click TO setup 노드'),
    'xboardCommissionConfirmed': MessageLookupByLibrary.simpleMessage('커미션 confirmed 확인'),
    'xboardCommissionIssuing': MessageLookupByLibrary.simpleMessage('커미션 issuing'),
    'xboardCompletePaymentInBrowser': MessageLookupByLibrary.simpleMessage('complete 결제 IN 브라우저'),
    'xboardConfigDownloadFailed': MessageLookupByLibrary.simpleMessage('설정 다운로드 실패'),
    'xboardConfigFormatError': MessageLookupByLibrary.simpleMessage('설정 format 오류'),
    ...
    'xboardConfirmRenewPlan': MessageLookupByLibrary.simpleMessage('확인 renew 요금제'),
    'xboardConfirmResetTraffic': MessageLookupByLibrary.simpleMessage('확인 초기화 트래픽'),
    'xboardCongratulationsSubscriptionActivated': MessageLookupByLibrary.simpleMessage('congratulations 구독 activated'),
    'xboardConnectGlobalQualityNodes': MessageLookupByLibrary.simpleMessage('연결 전역 품질 노드'),
    'xboardConnectionTimeout': MessageLookupByLibrary.simpleMessage('연결 시간이 초과되었습니다. 네트워크 연결을 확인하세요'),
    'xboardContactCustomerService': MessageLookupByLibrary.simpleMessage('고객지원'),
    ...
    'xboardCopySubscriptionLinkAbove': MessageLookupByLibrary.simpleMessage('복사 구독 링크 above'),
    'xboardCouponExpired': MessageLookupByLibrary.simpleMessage('쿠폰 만료됨'),
    'xboardCouponNotYetActive': MessageLookupByLibrary.simpleMessage('쿠폰 NOT YET active'),
    ...
    'xboardCreateTicketHint': MessageLookupByLibrary.simpleMessage('create 티켓 힌트'),
    ...
    'xboardCreatingOrderPleaseWait': MessageLookupByLibrary.simpleMessage('creating 주문 please wait'),
    ...
    'xboardCurrentPlanBased': MessageLookupByLibrary.simpleMessage('현재 요금제 based'),
    'xboardCurrentVersion': MessageLookupByLibrary.simpleMessage('현재 버전'),
    'xboardCustomRechargeAmount': MessageLookupByLibrary.simpleMessage('사용자 지정 충전 금액'),
    'xboardDays': MessageLookupByLibrary.simpleMessage('일'),
    'xboardDeductedBalance': MessageLookupByLibrary.simpleMessage('deducted 잔액'),
    'xboardDeductibleDuringPayment': MessageLookupByLibrary.simpleMessage('deductible during 결제'),
    'xboardDeviceAutoOfflineHint': MessageLookupByLibrary.simpleMessage('기기 자동 offline 힌트'),
    'xboardDeviceCurrentDeviceLabel': MessageLookupByLibrary.simpleMessage('기기 현재 기기 label'),
    ...
    'xboardDeviceLabelLastIp': MessageLookupByLibrary.simpleMessage('기기 label last IP'),
    'xboardDeviceLabelLastOnline': MessageLookupByLibrary.simpleMessage('기기 label last 온라인'),
    'xboardDeviceLabelOsVersion': MessageLookupByLibrary.simpleMessage('기기 label OS 버전'),
    'xboardDeviceLabelRevokedAt': MessageLookupByLibrary.simpleMessage('기기 label revoked AT'),
    'xboardDeviceLabelRevokedBy': MessageLookupByLibrary.simpleMessage('기기 label revoked BY'),
    ...
    'xboardDeviceNoRecordsHint': MessageLookupByLibrary.simpleMessage('기기 없음 기록 힌트'),
    ...
    'xboardDeviceRemoveCurrentConfirm': MessageLookupByLibrary.simpleMessage('기기 삭제 현재 확인'),
    ...
    'xboardDeviceUnknownVersion': MessageLookupByLibrary.simpleMessage('기기 알 수 없음 버전'),
    ...
    'xboardDiscountedPrice': MessageLookupByLibrary.simpleMessage('discounted 가격'),
    'xboardDocsCenter': MessageLookupByLibrary.simpleMessage('docs 센터'),
    'xboardDownloadingConfig': MessageLookupByLibrary.simpleMessage('downloading 설정'),
    ...
    'xboardEnjoyFastNetworkExperience': MessageLookupByLibrary.simpleMessage('enjoy fast 네트워크 experience'),
    'xboardEnterAmount': MessageLookupByLibrary.simpleMessage('enter 금액'),
    'xboardEnterCouponCode': MessageLookupByLibrary.simpleMessage('enter 쿠폰 코드'),
    'xboardEnterGiftCardCode': MessageLookupByLibrary.simpleMessage('enter 기프트 카드 코드'),
    'xboardEnterGiftCardCodeHint': MessageLookupByLibrary.simpleMessage('enter 기프트 카드 코드 힌트'),
    ...
    'xboardFailedToCheckPaymentStatus': MessageLookupByLibrary.simpleMessage('실패 TO 확인 결제 상태'),
    'xboardFailedToGetSubscriptionInfo': MessageLookupByLibrary.simpleMessage('실패 TO GET 구독 정보'),
    'xboardFailedToOpenPaymentLink': MessageLookupByLibrary.simpleMessage('실패 TO 열기 결제 링크'),
    'xboardFailedToOpenPaymentPage': MessageLookupByLibrary.simpleMessage('실패 TO 열기 결제 page'),
    ...
    'xboardGetGroupLinkFailed': MessageLookupByLibrary.simpleMessage('GET 그룹 링크 실패'),
    ...
    'xboardGiftCardCodeLabel': MessageLookupByLibrary.simpleMessage('기프트 카드 코드 label'),
    'xboardGiftCardRedeem': MessageLookupByLibrary.simpleMessage('기프트 카드 redeem'),
    'xboardGiftCardRedeemTitle': MessageLookupByLibrary.simpleMessage('기프트 카드 redeem 제목'),
    ...
    'xboardGroupLinkNotConfigured': MessageLookupByLibrary.simpleMessage('그룹 링크 NOT configured'),
    ...
    'xboardHighSpeedNetwork': MessageLookupByLibrary.simpleMessage('높음 속도 네트워크'),
    ...
    'xboardImportingSubscription': MessageLookupByLibrary.simpleMessage('importing 구독'),
    'xboardInsufficientBalance': MessageLookupByLibrary.simpleMessage('insufficient 잔액'),
    'xboardInvalidCredentials': MessageLookupByLibrary.simpleMessage('유효하지 않음 credentials'),
    'xboardInvalidOrExpiredCoupon': MessageLookupByLibrary.simpleMessage('유효하지 않음 OR 만료됨 쿠폰'),
    'xboardInvalidResponseFormat': MessageLookupByLibrary.simpleMessage('유효하지 않음 response format'),
    'xboardInviteCode': MessageLookupByLibrary.simpleMessage('초대 코드'),
    'xboardJoinGroup': MessageLookupByLibrary.simpleMessage('그룹 참여'),
    'xboardKeepSubscriptionLinkSafe': MessageLookupByLibrary.simpleMessage('keep 구독 링크 안전'),
    'xboardLater': MessageLookupByLibrary.simpleMessage('later'),
    'xboardLoadingFailed': MessageLookupByLibrary.simpleMessage('불러오는 중 실패'),
    'xboardLoadingPaymentPage': MessageLookupByLibrary.simpleMessage('불러오는 중 결제 page'),
    ...
    'xboardLoginToViewSubscription': MessageLookupByLibrary.simpleMessage('로그인 TO 보기 구독'),
    'xboardLogout': MessageLookupByLibrary.simpleMessage('로그아웃'),
    'xboardLogoutConfirmContent': MessageLookupByLibrary.simpleMessage('로그아웃 확인 내용'),
    'xboardLogoutConfirmTitle': MessageLookupByLibrary.simpleMessage('로그아웃 확인 제목'),
    ...
    'xboardMissingRequiredField': MessageLookupByLibrary.simpleMessage('missing 필수 field'),
    ...
    'xboardNetworkConnectionFailed': MessageLookupByLibrary.simpleMessage('네트워크 connection 실패'),
    ...
    'xboardNoAvailableNodes': MessageLookupByLibrary.simpleMessage('없음 사용 가능 노드'),
    'xboardNoAvailablePlan': MessageLookupByLibrary.simpleMessage('없음 사용 가능 요금제'),
    'xboardNoAvailableSubscription': MessageLookupByLibrary.simpleMessage('없음 사용 가능 구독'),
    'xboardNoInternetConnection': MessageLookupByLibrary.simpleMessage('없음 internet connection'),
    ...
    'xboardNoSubscriptionInfo': MessageLookupByLibrary.simpleMessage('없음 구독 정보'),
    'xboardNoSubscriptionPlans': MessageLookupByLibrary.simpleMessage('없음 구독 요금제'),
    ...
    'xboardOpenPaymentLinkFailed': MessageLookupByLibrary.simpleMessage('열기 결제 링크 실패'),
    'xboardOperationFailed': MessageLookupByLibrary.simpleMessage('operation 실패'),
    'xboardOperationTips': MessageLookupByLibrary.simpleMessage('operation 안내'),
    'xboardOrderCreationFailed': MessageLookupByLibrary.simpleMessage('주문 creation 실패'),
    'xboardOrderInfo': MessageLookupByLibrary.simpleMessage('주문 정보'),
    'xboardOrderLoadingFailed': MessageLookupByLibrary.simpleMessage('주문 불러오는 중 실패'),
    ...
    'xboardOrderStatusCancelled': MessageLookupByLibrary.simpleMessage('주문 상태 cancelled'),
    'xboardOrderStatusCompleted': MessageLookupByLibrary.simpleMessage('주문 상태 completed'),
    'xboardOrderStatusOffset': MessageLookupByLibrary.simpleMessage('주문 상태 offset'),
    'xboardOrderStatusOpening': MessageLookupByLibrary.simpleMessage('주문 상태 opening'),
    'xboardOrderStatusPending': MessageLookupByLibrary.simpleMessage('주문 상태 pending'),
    ...
    'xboardPaymentCancelled': MessageLookupByLibrary.simpleMessage('결제 cancelled'),
    'xboardPaymentComplete': MessageLookupByLibrary.simpleMessage('결제 complete'),
    'xboardPaymentCompleted': MessageLookupByLibrary.simpleMessage('결제 completed'),
    ...
    'xboardPaymentInstructions1': MessageLookupByLibrary.simpleMessage('결제 instructions 1'),
    'xboardPaymentInstructions2': MessageLookupByLibrary.simpleMessage('결제 instructions 2'),
    'xboardPaymentInstructions3': MessageLookupByLibrary.simpleMessage('결제 instructions 3'),
    'xboardPaymentLink': MessageLookupByLibrary.simpleMessage('결제 링크'),
    'xboardPaymentLinkCopied': MessageLookupByLibrary.simpleMessage('결제 링크 복사됨'),
    'xboardPaymentMethodVerified': MessageLookupByLibrary.simpleMessage('결제 방식 verified'),
    'xboardPaymentMethodVerifiedPreparing': MessageLookupByLibrary.simpleMessage('결제 방식 verified preparing'),
    'xboardPaymentMethods': MessageLookupByLibrary.simpleMessage('결제 방식'),
    'xboardPaymentPageAutoOpened': MessageLookupByLibrary.simpleMessage('결제 page 자동 opened'),
    'xboardPaymentPageOpenedCompleteAndReturn': MessageLookupByLibrary.simpleMessage('결제 page opened complete AND return'),
    'xboardPaymentPageOpenedInBrowser': MessageLookupByLibrary.simpleMessage('결제 page opened IN 브라우저'),
    ...
    'xboardPlanExpiryReminder': MessageLookupByLibrary.simpleMessage('요금제 expiry reminder'),
    ...
    'xboardPleaseEnterGiftCardCode': MessageLookupByLibrary.simpleMessage('please enter 기프트 카드 코드'),
    'xboardPleaseSelectPaymentPeriod': MessageLookupByLibrary.simpleMessage('please 선택 결제 기간'),
    'xboardPleaseWait': MessageLookupByLibrary.simpleMessage('please wait'),
    'xboardPoor': MessageLookupByLibrary.simpleMessage('나쁨'),
    'xboardPreparingImport': MessageLookupByLibrary.simpleMessage('preparing 가져오기'),
    'xboardPreparingPaymentPage': MessageLookupByLibrary.simpleMessage('preparing 결제 page'),
    ...
    'xboardProtectNetworkPrivacy': MessageLookupByLibrary.simpleMessage('protect 네트워크 개인정보'),
    'xboardProxy': MessageLookupByLibrary.simpleMessage('프록시'),
    'xboardProxyMode': MessageLookupByLibrary.simpleMessage('프록시 모드'),
    'xboardProxyModeDirectDescription': MessageLookupByLibrary.simpleMessage('프록시 모드 직접 연결 설명'),
    'xboardProxyModeGlobalDescription': MessageLookupByLibrary.simpleMessage('프록시 모드 전역 설명'),
    'xboardProxyModeRuleDescription': MessageLookupByLibrary.simpleMessage('프록시 모드 규칙 설명'),
    ...
    'xboardPurchaseSubscriptionToUse': MessageLookupByLibrary.simpleMessage('구매 구독 TO USE'),
    'xboardPurchaseTraffic': MessageLookupByLibrary.simpleMessage('구매 트래픽'),
    'xboardQuarterlyPayment': MessageLookupByLibrary.simpleMessage('quarterly 결제'),
    'xboardRecharge': MessageLookupByLibrary.simpleMessage('충전'),
    'xboardRechargeBalance': MessageLookupByLibrary.simpleMessage('충전 잔액'),
    'xboardRechargeBalanceTip': MessageLookupByLibrary.simpleMessage('충전 잔액 안내'),
    ...
    'xboardRememberPassword': MessageLookupByLibrary.simpleMessage('remember 비밀번호'),
    'xboardRenewPlan': MessageLookupByLibrary.simpleMessage('renew 요금제'),
    'xboardRenewToContinue': MessageLookupByLibrary.simpleMessage('renew TO continue'),
    ...
    'xboardReopenPaymentPageTip': MessageLookupByLibrary.simpleMessage('reopen 결제 page 안내'),
    'xboardResetCurrentPlanTraffic': MessageLookupByLibrary.simpleMessage('초기화 현재 요금제 트래픽'),
    'xboardResetTraffic': MessageLookupByLibrary.simpleMessage('초기화 트래픽'),
    'xboardResetTrafficByPlanCycle': MessageLookupByLibrary.simpleMessage('초기화 트래픽 BY 요금제 cycle'),
    'xboardResetTrafficConfirmContent': MessageLookupByLibrary.simpleMessage('초기화 트래픽 확인 내용'),
    ...
    'xboardReturnAfterPaymentAutoDetect': MessageLookupByLibrary.simpleMessage('return after 결제 자동 detect'),
    'xboardRunningTime': m42,
    'xboardSecureEncryption': MessageLookupByLibrary.simpleMessage('secure encryption'),
    'xboardSelectPaymentMethod': MessageLookupByLibrary.simpleMessage('선택 결제 방식'),
    'xboardSelectPaymentPeriod': MessageLookupByLibrary.simpleMessage('선택 결제 기간'),
    'xboardSelectPeriod': MessageLookupByLibrary.simpleMessage('선택 기간'),
    'xboardSelectRechargeAmount': MessageLookupByLibrary.simpleMessage('선택 충전 금액'),
    'xboardSendVerificationCode': MessageLookupByLibrary.simpleMessage('보내기 인증 코드'),
    ...
    'xboardSoftwareSettings': MessageLookupByLibrary.simpleMessage('software 설정'),
    ...
    'xboardSubscriptionHasExpired': MessageLookupByLibrary.simpleMessage('구독 HAS 만료됨'),
    ...
    'xboardSubscriptionLinkCopied': MessageLookupByLibrary.simpleMessage('구독 링크 복사됨'),
    ...
    'xboardThirtySixMonthCycle': MessageLookupByLibrary.simpleMessage('thirty SIX 월 cycle'),
    'xboardThreeMonthCycle': MessageLookupByLibrary.simpleMessage('three 월 cycle'),
    'xboardThreeYearPayment': MessageLookupByLibrary.simpleMessage('three 년 결제'),
    ...
    'xboardTicketDescriptionHint': MessageLookupByLibrary.simpleMessage('티켓 설명 힌트'),
    'xboardTicketPendingReply': MessageLookupByLibrary.simpleMessage('티켓 pending reply'),
    ...
    'xboardTokenExpiredContent': MessageLookupByLibrary.simpleMessage('토큰 만료됨 내용'),
    'xboardTokenExpiredTitle': MessageLookupByLibrary.simpleMessage('토큰 만료됨 제목'),
    ...
    'xboardTrafficExhausted': MessageLookupByLibrary.simpleMessage('트래픽 exhausted'),
    'xboardTrafficExhaustedRenewConfirmContent': MessageLookupByLibrary.simpleMessage('요금제를 갱신해도 트래픽은 즉시 초기화되지 않습니다. 바로 사용하려면 트래픽을 초기화하거나 요금제를 변경하세요. 계속하시겠습니까?'),
    'xboardTrafficLogHint': MessageLookupByLibrary.simpleMessage('최근 한 달간의 트래픽만 표시됩니다'),
    'xboardTrafficReminder': MessageLookupByLibrary.simpleMessage('트래픽 reminder'),
    ...
    'xboardTwelveMonthCycle': MessageLookupByLibrary.simpleMessage('twelve 월 cycle'),
    'xboardTwentyFourMonthCycle': MessageLookupByLibrary.simpleMessage('twenty four 월 cycle'),
    'xboardTwoYearPayment': MessageLookupByLibrary.simpleMessage('TWO 년 결제'),
    'xboardUnauthorizedAccess': MessageLookupByLibrary.simpleMessage('unauthorized access'),
    'xboardUnknownErrorRetry': MessageLookupByLibrary.simpleMessage('알 수 없음 오류 재시도'),
    ...
    'xboardUnsupportedCouponType': MessageLookupByLibrary.simpleMessage('지원하지 않는 쿠폰 유형'),
    ...
    'xboardUpdateSubscriptionRegularly': MessageLookupByLibrary.simpleMessage('업데이트 구독 regularly'),
    'xboardUploadImage': MessageLookupByLibrary.simpleMessage('업로드 이미지'),
    'xboardUsageInstructions': MessageLookupByLibrary.simpleMessage('사용량 instructions'),
    ...
    'xboardValidatingConfigFormat': MessageLookupByLibrary.simpleMessage('validating 설정 format'),
    'xboardValidationFailed': MessageLookupByLibrary.simpleMessage('validation 실패'),
    ...
    'xboardWaitingForPayment': MessageLookupByLibrary.simpleMessage('waiting FOR 결제'),
    'xboardWaitingPaymentCompletion': MessageLookupByLibrary.simpleMessage('waiting 결제 completion'),
