...
class DomainUser with _$DomainUser {
  ...
  bool get isExpiringSoon {
    if (expiredAt == null) return false;
    final daysRemaining = _naturalDaysUntil(expiredAt!);
  ...
  String formatBytes(int bytes) {
    ...
    if (bytes < 1024 * 1024) return '${_formatUnitValue(bytes / 1024)} KB';
    if (bytes < 1024 * 1024 * 1024) {
      return '${_formatUnitValue(bytes / (1024 * 1024))} MB';
    }
    return '${_formatUnitValue(bytes / (1024 * 1024 * 1024))} GB';
  }
