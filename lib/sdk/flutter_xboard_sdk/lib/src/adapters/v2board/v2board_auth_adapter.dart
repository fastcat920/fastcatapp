...
class V2BoardAuthAdapter implements AuthApi {
  ...
  Future<String?> login(
    ...
    // V2Board uses 'auth_data', XBoard uses 'token' — try both
  ...
  Future<bool> register(String email, String password,
    ...
    // 注意: register API 签名是 (email, password, inviteCode, emailCode)
    final response =
        await _registerApi.register(email, password, inviteCode, emailCode);
