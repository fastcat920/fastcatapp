...
import '../../panels/xboard/apis/xboard_ticket_api.dart';
import '../../panels/xboard/models/xboard_ticket_models.dart';

class XBoardTicketAdapter implements TicketApi {
  final XBoardTicketApi _api;

  XBoardTicketAdapter(this._api);
  ...
  Future<bool> closeTicket(int id) async {
    await _api.closeTicket(id.toString());
    return true;
  }
