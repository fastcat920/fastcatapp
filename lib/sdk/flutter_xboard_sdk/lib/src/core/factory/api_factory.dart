...
class ApiFactory {
  ...
  final void Function(List<String>)? onGatewayUrls;

  ApiFactory(this._panelType, this._httpService, {this.onGatewayUrls});
    ...
    switch (_panelType) {
      case PanelType.xboard:
        return XBoardAuthAdapter(
          XBoardLoginApi(_httpService, onGatewayUrls: onGatewayUrls),
      ...
      case PanelType.xv2b:
        return V2BoardAuthAdapter(
          V2BoardLoginApi(_httpService, onGatewayUrls: onGatewayUrls),
