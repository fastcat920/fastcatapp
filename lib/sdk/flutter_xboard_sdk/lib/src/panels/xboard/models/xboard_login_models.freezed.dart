...
class _$LoginDataImpl implements _LoginData {
  const _$LoginDataImpl(
      {this.token,
      @JsonKey(name: 'auth_data') this.authData,
  ...
  @override
  String toString() {
    return 'LoginData(token: $token, authData: $authData, user: $user)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, token, authData, const DeepCollectionEquality().hash(_user));
...
abstract class _LoginData implements LoginData {
  const factory _LoginData(
      {final String? token,
      @JsonKey(name: 'auth_data') final String? authData,
      final Map<String, dynamic>? user}) = _$LoginDataImpl;
...
class _$LoginResponseImpl implements _LoginResponse {
  const _$LoginResponseImpl({required this.success, this.message, this.data});
