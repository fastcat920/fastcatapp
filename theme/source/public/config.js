...
window.EZ_CONFIG = {
  ...
  // 中间件服务器URL (不含路径)
  API_MIDDLEWARE_URL: 'https://test.test.test',
  ...
  SITE_CONFIG: {
    siteName: '快猫',
    siteDescription: '快猫 UI',
    // copyright会自动使用当前年份
    copyright: `© ${new Date().getFullYear()} 快猫. All Rights Reserved.`,
    ...
    landingText: {
      'zh-CN': '专注海外网络优化',
      'en-US': 'Focus on overseas network optimization'
    },
  ...
  DEFAULT_CONFIG: {
    ...
    // 主题色 (16进制颜色值)
    // 与 FastCat 客户端保持一致；后台主题设置中的“主题主色”仍可覆盖此默认值。
    primaryColor: '#4566AE',
  ...
  PAYMENT_CONFIG: {
    ...
    openPaymentInNewTab: false, // 默认在当前页面打开
  ...
  CUSTOMER_SERVICE_CONFIG: {
    ...
    customHtml: '<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="d5182e08-1faa-4fa9-b3c2-2a34f1975d5f";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>',
